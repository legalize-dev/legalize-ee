...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/429052025035"
...
(6) Kui taotletakse planeeritavate kulude kompenseerimist, lisatakse taotlusele vajalike kulude ülevaade ja kalkulatsioon või hinnapakkumised.
...
(8) Teenuseid osutatakse üldjuhul peale haldusakti väljaandmist teenuse osutaja ja kliendi vahel sõlmitud lepingu, vallavalitsuse ja teenuse osutaja vahelise lepingu või asutustevahelise koostöölepingu alusel.
...
(3) Sotsiaalametnik vaatab vähemalt kord aastas läbi teenuse osutamise haldusaktid, hinnates üle teenuse saaja abi- ja toetusvajaduse.
...
(3) Teenust on õigustatud saama täisealine isik:

1) kelle rahvastikuregistrijärgne elukoht on Põhja-Pärnumaa vallas;
...
(1) Teenuse saamiseks esitatakse taotlus vallavalitsusele.
...
(7) Sotsiaalametnik vaatab vähemalt kord aastas läbi teenuse eest tasumise haldusaktid, kontrollides teenuse saaja ja ülapidamiskohustuslaste majanduslikku seisu ja teenuse vajalikkust.
...
(3) Kui taotleja või tema ülalpidamiskohuslaste maksevõime ei võimalda teenuse eest täies või osalises mahus tasuda või kui ülalpidajatelt on ülalpidamiskohustust ebamõistlik nõuda, võib taotleda vallavalitsuselt täiendavat toetust teenuse eest tasumiseks.
...
2) tähtajatult määratud arstliku ekspertiisi otsuse alusel tähtajatuks.
...
8) hooldaja või hooldatava ööpäevaringsele teenusele asumise korral;

9) muudel asjaoludel, mis teevad võimatuks hoolduse teostamise.
...
(4) Sotsiaalametnikul on õigus põhjendatud juhtudel otsustada teenuse saamise õigus isikule, kellel ei ole puuetega inimeste sotsiaaltoetuste seaduse § 2 lõike 1 tähenduses puuet juhul, kui isiku tervislik seisund ei võimalda muud sõiduvahendit kasutada ja tal puuduvad muud võimalused vajaliku abi saamiseks.
...
(6) Eluruumi tagamise ja sotsiaalmajutusteenuse osutamiseks sõlmib teenuse osutaja sotsiaalametniku poolt tehtud otsuse alusel lepingu teenust vajava isikuga. Sotsiaaleluruumide üürilepingud sõlmitakse tähtajaga kuni kaks aastat, kohustusega vabastada eluruum tähtaja saabumisel. Sotsiaalmajutusteenuse lepingud võivad olla sõlmitud tähtajatult. Lepingus sätestatakse osapoolte õigused, kohustused eluruumi ja sotsiaalmajutuse kasutamisel, sh tasu eluruumi kasutamise eest.
...
(1) Lapsehoiuteenust on õigus taotleda raske või sügava puudega lapse seaduslikul esindajal kuni selle kalendriaasta lõpuni, kui laps saab 18-aastaseks ja kelle elukoht on Põhja-Pärnumaa valla territooriumil. Põhjendatud juhtudel ja tulenevalt abivajadusest on õigus lapsehoiuteenust taotleda ka ilma puude raskusastmeta lapse seaduslikul esindajal.

(2) Sotsiaalametnik hindab lapsehoiuteenust vajava lapse abivajaduse.
...
#### 14. jagu Vaimse tervise teenused

##### § 68. Teenuse eesmärk ja sisu

(1) Vaimse tervise teenused on vallavalitsuse poolt osutatavad või korraldatavad teenused, mille eesmärk on tagada elanikele nende abivajadusest lähtuvalt psühhosotsiaalset või psühholoogilist abi.

(2) Vaimse tervise teenused on:
...
4) tugigruppides ja tugiprogrammides osalemine;

5) hingehoiuteenus;

6) muud vaimset tervist toetavad teenused.

(3) Vaimse tervise teenuse osutajal peab olema konkreetse teenuse pakkumiseks sobiv ja asjakohane ettevalmistus.

(4) Vaimse tervise teenuseid on õigus taotleda isikutel, kes ei ole sotsiaalmajanduslikest põhjustest tulenevalt võimelised enda vajadustele vastavaid teenuseid tagama.

(5) Sotsiaalametnik hindab teenust vajava isiku abivajaduse, arvestab taotleja majanduslikku ja psühhosotsiaalset toimetulekuvõimet ning otsustab teenuse osutamise haldusaktiga, milles märgib teenuse osutaja, kestvuse ja/või mahu.

(6) Teenuse taotleja võib valida ise või koostöös sotsiaalametnikuga sobiva teenuseosutaja.

(7) Teenust osutatakse isikule koostöös teenuse osutaja ja vallavalitsusega.

(8) Erandkorras võib esitada taotluse varasemalt tehtud vaimse tervisega seotud kulutuste kompenseerimiseks.

(9) Sotsiaalametnik lõpetab teenuse osutamise, kui:

1) teenust saav isik või perekond asub elama teise omavalitsuse territooriumile;

2) muudel võimalikel juhtudel.

(10) Teenust rahastatakse vallaeelarvest. Vaimse tervise teenuste osutamine teenuse saajale on üldjuhul tasuta. Vallavalitsusel on õigus rahastada vaimse tervise teenuseid ka osaliselt, tuginedes taotleja sotsiaalmajanduslikule olukorrale.

#### 15. jagu Muud sotsiaalteenused

##### § 68<sup>1</sup>. Muude sotsiaalteenuste korraldamine

(1) Vallavalitsus võib korraldada isikule muude sotsialteenuste (psühholoogiline nõustamine, tõlketeenus, jms) osutamise, lähtudes isiku kõrvalabi vajadusest.
...
(1) Hooldajatoetus määratakse ja makstakse kuni 18. a puudega lapse ühele lapsevanemale või lapse seaduslikule esindajale, kui puudega laps vajab eakohasest hooldusvajadusest suuremal määral pidevat kõrvalabi, juhendamist ja järelevalvet.
...
(1) Toitlustamise eest tasumisest vabastatakse rahvastikuregistrijärgselt Põhja-Pärnumaa valla nelja- ja enamalapseliste perede valla munitsipaallasteaedades käivad lapsed vanema taotluse alusel.
