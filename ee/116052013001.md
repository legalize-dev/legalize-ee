...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/116052013001"
...
2) 3. ja 5. peatükis kompleksluba või kompleksloa kohustuse puudumise korral välisõhu saasteluba;

3) 4. peatükis kompleksluba või kompleksloa kohustuse puudumise korral jäätmeluba jäätmete põletamiseks vastavalt jäätmeseaduse 6. peatüki 5. jaos sätestatule koos välisõhu saasteloaga vastavalt välisõhu kaitse seaduse 3. peatüki 1. jaos sätestatule ja vee erikasutusloaga vastavalt veeseaduse 2. peatükis sätestatule.
...
(4) Käesoleva paragrahvi lõikes 3 sätestatud juhul keskkonnajärelevalve seaduse § 22 lõiget 2 ei kohaldata.
...
(3) Alltegevusvaldkondade loetelu käesoleva paragrahvi lõikes 2 nimetatud tegevusvaldkondade raames ning künnisvõimsused, mille korral on käitise tegevuse jaoks nõutav kompleksluba,
...
(2) Kui vähemalt ühes kompleksluba nõudvas käitise tegevusvaldkonnas ületab tegevus käesoleva seaduse § 19 lõike 3 alusel kehtestatud alltegevusvaldkonna künnisvõimsuse, on kompleksluba nõutav käitise kui terviku käitamiseks. Sel juhul asendab kompleksluba veeseaduse, jäätmeseaduse ja välisõhu kaitse seaduse kohased load.
...
(1) Kompleksloa taotlus esitatakse loa andjale. Võimaluse korral esitatakse taotlus digitaalses vormingus ja digitaalselt allkirjastatuna.
...
(6) Kompleksloa taotluse ja selle lisade vormid
...
2) ohtliku ja suurõnnetuse ohuga ettevõtte puhul kemikaaliseaduse § 13<sup>1</sup> lõike 2 kohaselt nõutavad dokumendid;
...
(4) Kompleksluba ja selle andmise otsus vormistatakse elektrooniliselt digitaalselt allkirjastatuna või paberil.
...
3) käitise tegevuse eesmärk, põhitegevusala ja käesoleva seaduse § 19 lõike 3 alusel kehtestatud alltegevusvaldkonna nimetus, sealhulgas käitise tööaeg, aastane tootmismaht ja ülesseatud tootmisvõimsus;
...
(5) Kompleksloa sisu täpsustavad nõuded ja kompleksloa vormi
...
(2) Heite piirväärtusi, võrdväärseid parameetreid või tehnilisi meetmeid määrates arvestab loa andja käitise saasteallikast keskkonda heidetavate ainete olemust ja nende poolt põhjustatava saastatuse võimalikku kandumist ühest keskkonnaelemendist teise.
...
(1) Kui käitise tegevus on tegevusalade loetelus, mis on kehtestatud välisõhu kaitse seaduse § 120 lõike 1 alusel, ei määrata loas kasvuhoonegaaside heitele piirväärtust, välja arvatud juhul, kui see on vajalik saastatuse tekke ärahoidmiseks kohalikul tasandil.
...
(2) käesoleva seaduse § 41 lõike 2 punktis 11 nimetatud pinnase ja põhjavee saastatuse seire täpsustatud nõuded.
...
(2) Kompleksloa andmise ja selle muutmise otsus ning kompleksloa läbivaatamisel tehtud otsus kompleksloa nõuete muutmata jätmise kohta tehakse kättesaadavaks Keskkonnaministeeriumi ja Keskkonnaameti veebilehel ning keskkonnalubade infosüsteemis.
...
(1) Väävliärastuse aste on teatava aja vältel põletusseadmest välisõhku eraldumata jäänud väävli ja sama aja jooksul põletusseadmesse pandud ja põletusseadmes kasutatud tahkes kütuses sisalduva väävli suhe.
...
(1) Suurte põletusseadmete saasteainete heite piirväärtused
...
(1) Saasteainete heite piirväärtuste kohaldamise nõuded mitme kütuse põletusseadme korral
...
(1) Suure põletusseadme korral, mille summaarne nimisoojusvõimsus on 100 megavatti või enam, mõõdetakse saasteallika väljuvates gaasides pidevalt järgmiste saasteainete sisaldust:
...
2) eralduva vääveldioksiidi ja tahkete osakeste sisalduse mõõtmise nõudmisest maagaasil töötava suure põletusseadme korral;

3) eralduva vääveldioksiidi sisalduse mõõtmise nõudmisest teatud väävlisisaldusega vedelkütusel töötava suure põletusseadme korral, millel puudub väävliärastusseade;
...
(7) Käesoleva paragrahvi lõike 1 kohaselt pidevmõõtmiste tegemisel mõõdetakse saasteallika tööparameetreid, nagu väljuva gaasi hapnikusisaldust, temperatuuri, rõhku ja veeaurusisaldust. Väljuva gaasi veeaurusisalduse pidevmõõtmine ei ole vajalik, kui väljuva gaasi proov kuivatatakse enne selle analüüsimist.
...
(2) Tehas loetakse rajatuks, kui käitajale on väljastatud ehitusseaduse § 32 kohane ehitise kasutusluba.
...
(3) Täpsemad nõuded jäätmepõletus- ja koospõletustehase käitamisele
...
(3) täpsustatud nõuded erandite kohaldamisele jäätmepõletus- ning koospõletustehaste käitamisnõuete osas.
...
3) jäätmeliik ja koodinumber, mis on kehtestatud jäätmeseaduse § 2 lõike 4 alusel;
...
(1) Jäätmepõletus- ja koospõletustehastest väljuvates gaasides sisalduvate saasteainete heite piirväärtused

määrusega.

(2) Jäätmepõletus- ja koospõletustehastest väljuvates gaasides sisalduvate dioksiinide ja furaanide samaväärsuskordajad
...
(1) Välisõhku jäätmepõletus- ja koospõletustehastest väljutatava heite piirväärtustele vastavuse hindamise kriteeriumid
...
(3) Jäätmepõletus- ja koospõletustehastest väljuvate gaaside puhastamisel tekkiva reovee käitlemise tulemusena tekkiva heitvee saasteainete heite piirväärtused

määrusega.

(4) Jäätmepõletus- ja koospõletustehastest väljuvate gaaside puhastamisel tekkiva reovee käitlemise tulemusena tekkivas heitvees sisalduvate dioksiinide ja furaanide samaväärsuskordajad
...
(1) Suublasse juhitava heite piirväärtustele vastavuse hindamise kriteeriumid
...
(3) Nõuded saasteainete sisalduse regulaarsele mõõtmisele jäätmepõletus- ja koospõletustehastest väljuvates gaasides ning heitvees
...
(1) Käesoleva seaduse § 106 lõikes 1 nimetatud tehase sulgemise vajadusest või käitaja esitatud sulgemise taotlusest teavitab loa andja viivitamata tehase teeninduspiirkonna maakondade maavanemaid ning valla- ja linnavalitsusi, samuti teisi isikuid, keda sulgemine oluliselt puudutab, ja avaldab tehase sulgemise menetluse algatamise teate kohalikus ning maakondlikus ajalehes, ametlikus väljaandes Ametlikud Teadaanded ja Keskkonnaameti veebilehel.
...
(1) Väljuv gaas käesoleva peatüki tähenduses on lenduvaid orgaanilisi ühendeid või teisi saasteaineid sisaldav gaas, mis eraldub välisõhku käitise korstna või püüdeseadme kaudu.
...
(1) Käitaja, kellel puudub käesoleva seaduse §-s 113 sätestatud tegevusaladel tegutsemiseks kohustus omada kompleksluba vastavalt käesoleva seaduse § 19 lõikele 2 või kohustus omada välisõhu saasteluba vastavalt välisõhu kaitse seaduse § 68 lõikele 1, peab oma tegevuse Keskkonnaametis registreerima, kui tema tegevus ületab käesoleva seaduse §-s 113 nimetatud künnisvõimsusi ja kui lenduvate orgaaniliste ühendite heide ühel käitise tootmisterritooriumil jääb alla 0,1 tonni aastas (edaspidi *registreerimiskohustusega käitaja*).
...
(4) Orgaanilisi lahusteid kasutava käitise registreerimise teate vormi ja registreerimistõendi vormi
...
(1) Lahustite kasutamisel välisõhku eralduvate lenduvate orgaaniliste ühendite heite piirväärtused
...
(1) Lenduvate orgaaniliste ühendite heite piirväärtustele vastavuse hindamise kriteeriumid

määrusega.

##### § 139. Lenduvate orgaaniliste ühendite heitkoguste vähendamise kava

(1) Loa andja võib käitaja taotlusel asendada lahustite kasutamisel eralduvate lenduvate orgaaniliste ühendite heite piirväärtuste järgimise kohustuse lenduvate orgaaniliste ühendite heitkoguste vähendamise kava koostamise ja järgimise kohustusega.
...
(4) Lenduvate orgaaniliste ühendite heitkoguste vähendamise kava koostamise nõuded pinnakattevahendi, laki, liimi või trükivärviga katmise tegevusalaga tegutseva käitaja jaoks

määrusega.

(5) lenduvate orgaaniliste ühendite heitkoguste vähendamise kava koostamise nõuded ka käesoleva paragrahvi lõikes 4 nimetamata tegevusalal tegutseva käitaja jaoks.

##### § 140. Ohtlike ainete asendamine

(1) Ained või segud, mis on nende lenduvate orgaaniliste ühendite sisalduse tõttu klassifitseeritud Euroopa Parlamendi ja nõukogu määruse (EÜ) nr 1272/2008 kohaselt kantserogeenseks, mutageenseks või reproduktiivtoksiliseks ning mis kannavad või peavad kandma ohulauset H340, H350, H350i, H360D või H360F või kemikaaliseaduse § 41 lõike 4 alusel kehtestatud riskilauset R45, R46, R49, R60 või R61, asendab käitaja võimalikult kiiresti ja võimalikult suures mahus vähem kahjulike ainete või segudega tehniliselt ja praktiliselt võimaliku määrani, mis on määratletud toote kemikaaliohutuse aruandes vastavalt Euroopa Parlamendi ja nõukogu määruses (EÜ) nr 1907/2006 sätestatud korrale.
...
(1) Käitisest välisõhku eralduva heite seireks tehakse väljalasetel pidevaid või perioodilisi mõõtmisi. Perioodilise seire korral tehakse ühe mõõtmisseeria jooksul vähemalt kolm mõõtmist.

(2) Gaasikäikudes, millega on ühendatud lenduvate orgaaniliste ühendite põletus- või püüdeseadmed ja mille heite välisõhku väljumise lõpp-punktist eraldub süsinikku keskmiselt üle 10 kilogrammi tunnis, tuleb heiteid mõõta pidevalt.
...
(4) Nõuded lahustite kasutuskava koostamiseks ja rakendamiseks
...
(1) Käesoleva peatüki kohaldamisalasse kuuluvate käitiste kehtivad välisõhu saasteload ja nende muudatused ning andmed registreerimiskohustusega käitajate kohta tehakse avalikkusele kättesaadavaks keskkonnalubade infosüsteemi veebilehel.
...
(3) Orgaanilisi lahusteid kasutava käitise kohta käiva teabe avalikustamisele kohaldatakse lisaks käesolevas jaos sätestatule ka välisõhu kaitse seaduses sätestatud nõudeid.
...
(2) Saasteainete heite piirväärtused titaandioksiidi tootvate käitiste väljuvates gaasides

määrusega.

(3) Saasteainete heite piirväärtused titaandioksiidi tootvate käitiste heitvees
...
(3) Täpsustatud nõuded titaandioksiidi tootvate käitiste väljuvate gaaside seire kohta
...
(2) Korrapärase kontrolli tulemused vormistatakse kontrolli aruandena, mis edastatakse käitajale ja avalikustamiseks Keskkonnaministeeriumile.
...
(1) Käesolevas seaduses ja selle alusel kehtestatud õigusaktides sätestatud nõuete täitmise üle teostab järelevalvet Keskkonnainspektsioon keskkonnajärelevalve seaduses sätestatud korras.

(2) Järelevalvet teostaval isikul on õigus teha käesoleva seaduse täitmise tagamiseks ettekirjutusi. Ettekirjutuse täitmata jätmise korral on asendustäitmise ja sunniraha seaduses sätestatud korras rakendatava sunniraha ülemmäär 32 000 eurot.
...
(1) Käesolevas seaduses sätestatud väärtegudele kohaldatakse karistusseadustiku üldosa ja väärteomenetluse seadustiku sätteid.
...
##### § 170. Jäätmeseaduse muutmine

(1) Jäätmeseaduses tehakse järgmised muudatused:

**1)** paragrahvi 2<sup>1</sup> lõikes 3 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrollimise seaduse” tekstiosaga „tööstusheite seaduse”;

**2)** paragrahvi 29 lõikes 3 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrollimise seaduse §-s 4” tekstiosaga „tööstusheite seaduse §-s 8”;

**3)** paragrahvi 33 lõike 1 punktid 2 ja 3 tunnistatakse kehtetuks;

**4)** paragrahvi 33 lõike 2 punktid 2 ja 3 tunnistatakse kehtetuks;

**5)** paragrahv 37 tunnistatakse kehtetuks;

**6)** paragrahvi 91 lõike 1 punkt 5 muudetakse ja sõnastatakse järgmiselt:
...
**7)** paragrahvi 91 täiendatakse lõikega 1<sup>1</sup> järgmises sõnastuses:

„(1<sup>1</sup>) Käesoleva paragrahvi lõike 1 punktis 5 nimetatud kindlustusleping või rahaline tagatis peab kehtima kogu prügila kasutamise, sulgemise ja järelhoolduse ajal, et tagada käitaja suutlikkus täita oma ülesandeid.”;
...
**9)** paragrahvi 96 punkt 2 tunnistatakse kehtetuks.

##### § 171. Kemikaaliseaduse muutmine

(1) Kemikaaliseaduse § 13<sup>4</sup> lõikes 2 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrollimise seaduse” tekstiosaga „tööstusheite seaduse”.

##### § 172. Keskkonnavastutuse seaduse muutmine

(1) Keskkonnavastutuse seaduse § 8 lõike 2 punktis 1 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrollimise seaduse” tekstiosaga „tööstusheite seaduse”.

##### § 173. Riigilõivuseaduse muutmine

(1) Riigilõivuseaduses tehakse järgmised muudatused:

**1)** seaduse 6. peatüki 3. jao 1. jaotise pealkiri muudetakse ja sõnastatakse järgmiselt:

„**Tööstusheite seaduse alusel tehtavad toimingud**”;

**2)** paragrahvi 93 tekstist jäetakse välja sõna „iga-aastase”.

##### § 174. Saastuse kompleksse vältimise ja kontrollimise seaduse kehtetuks tunnistamine

(1) Saastuse kompleksse vältimise ja kontrollimise seadus tunnistatakse kehtetuks.

##### § 175. Välisõhu kaitse seaduse muutmine

(1) Välisõhu kaitse seaduses tehakse järgmised muudatused:
...
**3)** seaduse 1. peatüki 5. jao pealkirjas asendatakse sõnad „heitkoguste piirväärtused” sõnadega „heite piirväärtused”;

**4)** paragrahv 47 muudetakse ja sõnastatakse järgmiselt:
...
**5)** paragrahvi 47 täiendatakse lõikega 3 järgmises sõnastuses:
...
**7)** paragrahvi 51 lõige 1 muudetakse ja sõnastatakse järgmiselt:
...
**8)** paragrahvi 66 lõige 5 muudetakse ja sõnastatakse järgmiselt:
...
**9)** paragrahvi 67 lõige 2 muudetakse ja sõnastatakse järgmiselt:
...
**11)** paragrahvi 79 lõike 1 punkt 3 muudetakse ja sõnastatakse järgmiselt:
...
**12)** paragrahvi 80 täiendatakse lõikega 1<sup>1</sup> järgmises sõnastuses:

„(1<sup>1</sup>) Jäätmepõletus- või koospõletustehase korral määratakse saasteloaga lisaks käesoleva paragrahvi lõikes 1 sätestatule:
...
**13)** paragrahvi 80 lõiked 2 ja 3 muudetakse ning sõnastatakse järgmiselt:
...
**14)** paragrahvi 85 lõike 1 punkt 1 muudetakse ja sõnastatakse järgmiselt:
...
**16)** paragrahvi 89 lõike 1 sissejuhatav lauseosa ja punkt 1 muudetakse ning sõnastatakse järgmiselt:
...
**17)** paragrahvi 89 lõike 1 punktid 3 ja 4 muudetakse ning sõnastatakse järgmiselt:
...
**18)** paragrahvi 89 lõike 1 punkt 5 tunnistatakse kehtetuks;

**19)** paragrahvi 89 lõike 1 punktid 6–8 muudetakse ja sõnastatakse järgmiselt:
...
**20)** paragrahvi 89 täiendatakse lõigetega 1<sup>1</sup>–1<sup>3</sup> järgmises sõnastuses:

„(1<sup>1</sup>) Käesoleva paragrahvi lõike 1 punktis 4 sätestatud saasteainete püüdeseadme efektiivsuse kontrollimise sagedus määratakse saasteloa või keskkonnakompleksloaga kokkuleppel loa andjaga.

(1<sup>2</sup>) Kui saasteallika käitaja ei saa tehnilistel või majanduslikel põhjustel tagada käesoleva paragrahvi lõike 1 punktis 1 nimetatud nõuete täitmist kindlaks määratud tähtpäevaks, teatab ta sellest viivitamata Keskkonnaametile ning kohaliku omavalitsuse organile, koostab loa andja nõudmisel saasteaine heitkoguse vähendamise tegevuskava ja esitab selle heakskiitmiseks Keskkonnaametile, kohaliku omavalitsuse organile ja Keskkonnainspektsioonile.

(1<sup>3</sup>) Paikse saasteallika käitaja, kes on kohustatud omama keskkonnakompleksluba, peab lisaks käesoleva paragrahvi lõikes 1<sup>2</sup> nimetatud nõuete täitmisele tõestama lõikes 1<sup>2</sup> nimetatud asutustele, et ta kasutab parimat võimalikku tehnikat.”;

**21)** paragrahvi 89 lõige 3 muudetakse ja sõnastatakse järgmiselt:
...
**22)** paragrahvi 90 lõike 1 sissejuhatav lauseosa muudetakse ja sõnastatakse järgmiselt:
...
**23)** paragrahvi 90 lõike 1 punktis 6 asendatakse sõnad „heitkoguse piirväärtusi” sõnadega „heite piirväärtusi”;

**24)** seaduse 5. peatükk tunnistatakse kehtetuks;

**25)** paragrahv 146 tunnistatakse kehtetuks;

**26)** paragrahvi 148 tekst muudetakse ja sõnastatakse järgmiselt:
...
**27)** paragrahv 149 tunnistatakse kehtetuks.

##### § 176. Veeseaduse muutmine

(1) Veeseaduses tehakse järgmised muudatused:

**1)** paragrahvi 3<sup>15</sup> lõike 3 punktis 1 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrollimise seadusele” tekstiosaga „tööstusheite seadusele”;

**2)** paragrahvi 3<sup>15</sup> lõike 3 punktis 7 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrolli seadusega” tekstiosaga „tööstusheite seadusega”;

**3)** paragrahvi 33<sup>4</sup> lõike 4 punktis 3 asendatakse tekstiosa „saastuse kompleksse vältimise ja kontrollimise seaduse § 7 lõikes 3” tekstiosaga „tööstusheite seaduse § 19 lõikes 2”.
