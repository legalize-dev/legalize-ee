...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/127022019003"
...
1) lihtsustada keskkonnakomplekslubade (edaspidi *kompleksluba*) ja kiirgustegevuslubade taotlemist ja menetlemist, loaga seotud seire-, aruandlus- ja muude kohustuste täitmist ning kogutud andmete säilitamist, kasutamist ja kättesaadavust;
...
8) töötleb kompleksloaga seotud andmeid – sealhulgas taotlusel ja loal, välisõhu saastamise, veekasutuse ja jäätmealase tegevuse aruannetes (edaspidi *keskkonnakasutuse aastaaruanded*) kajastatud andmeid ning seireandmeid ja keskkonnatasude andmeid – õigusaktides sätestatud kohustuste täitmiseks;
...
1) töötleb komplekslubadega seotud keskkonnakasutuse aastaaruannete ja jäätmekäitluskohtadega seonduvaid andmeid õigusaktides sätestatud kohustuste täitmiseks;
...
1) kompleksloa taotluste, komplekslubade, keskkonnakasutuse aruannete, komplekslubade alusel tehtava seire, kontrollseire ja kompleksloa kohustusega käitise korrapärase keskkonnaalase kontrolliga seotud andmed;

2) kiirgustegevusloa taotluste, kiirgustegevuslubade, kiirgustegevuslubadest tulenevate kohustuste täitmisega ning kiirgusallikate ja tuumamaterjaliga seotud andmed;

3) keskkonnatasudega seotud andmed.
...
2) keskkonnatasude seaduses ning keskkonnatasude seaduse § 33<sup>3</sup> lõike 3 alusel kehtestatud määruses – kompleksloa alusel toimuva tegevusega seoses esitatud keskkonnatasu deklaratsioonide andmed;
...
6) jäätmeseaduse § 117 lõike 1 alusel kehtestatud määruses – jäätmealase tegevuse aruannete andmed;
...
8) veeseaduse § 21 lõike 2 alusel kehtestatud määruses – veekasutuse aruannete andmed;
...
1) taotlus käesoleva määruse § 7 lõikes 1 nimetatud loa (edaspidi *luba*) saamiseks, muutmiseks, peatamiseks või kehtetuks tunnistamiseks;

2) haldusakt loa andmise, muutmise, peatamise või kehtetuks tunnistamise kohta;

3) loaga seonduv käesoleva lõike punktides 1 ja 2 nimetamata menetlusdokument;

4) keskkonnatasu deklaratsioon;

5) keskkonnatasu teade;

6) saastetasu asendamise leping;

7) keskkonnakasutuse aastaaruanne;

8) loaga seonduva seire aruanne;

9) kontrollseire aruanne;

10) keskkonnajärelevalvega seotud dokumendid;

12) kiirgusseaduse § 37 lõikes 1 sätestatud kiirgusallika ja radioaktiivsete jäätmete inventuuri aruanne;

13) kiirgusseaduse § 33 lõikes 2 sätestatud tuumamaterjali koguse muudatuse teade;

14) radioaktiivse aine ja tuumamaterjali riigist väljaviimise teade;

15) radioaktiivse aine ja tuumamaterjali riiki sissetoomise teade.
...
##### § 9. Andmete esitaja ja andmekogu kasutaja isikusamasuse tuvastamine ja autoriseerimine
...
(2) Andmete esitaja ja andmekogu kasutaja isikusamasuse tuvastamine toimub ID-kaardiga või Mobiil-ID-ga.
