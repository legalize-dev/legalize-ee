...
status: "in_force"
source: "https://www.riigiteataja.ee/akt/123072025007"
...
rt_year: "2025"
rt_article: "7"
rt_reference: "123072025007"
effective_from: "2025-07-26"
...
1<sup>1</sup>) lihtsustada atmosfääriõhu kaitse seaduse, jäätmeseaduse, kiirgusseaduse, tööstusheite seaduse ja veeseaduse alusel tehtavate registreeringute (edaspidi *registreeringud*) taotlemist ja menetlemist, nendega seotud aruandluskohustuste täitmist ning kogutud andmete säilitamist, kasutamist ja kättesaadavust;
...
4) lihtsustada kaevise tarbimise või võõrandamise lubade ja maavara või maavarana arvele võtmata kivimi ja setendi võtmise lubade taotlemist ja menetlemist ning loaga seotud andmete säilitamist, kasutamist ja kättesaadavust;

5) lihtsustada jahipiirkonna kasutusõiguse lubade taotlemist ja menetlemist ja lubadega seotud muude kohustuste täitmist ning kogutud andmete säilitamist, kasutamist ja kättesaadavust;

6) lihtsustada keskkonnamõju hindamise ja keskkonnamõju strateegilise hindamise dokumentidega seotud andmete säilitamist, kasutamist ja kättesaadavust;

7) lihtsustada keskkonnatasude seaduse tähenduses tasukohustuse täitmist ning kogutud andmete säilitamist, kasutamist ja kättesaadavust;

8) lihtsustada ohtlike jäätmete ja välislepinguga reguleeritavate jäätmete veolubade ja selliste jäätmete riikidevahelise veo, milleks veoluba ei ole vajalik, saatedokumentide taotlemist, menetlemist ja esitamist ning kogutud andmete säilitamist, kasutamist ja kättesaadavust.
...
8<sup>4</sup>) töötleb registreeringutega seotud andmeid – sealhulgas taotlusel ja registreeringul kajastatud andmeid ning keskkonnakasutuse aastaaruannetes kajastatud andmeid – õigusaktides sätestatud kohustuste täitmiseks;

8<sup>5</sup>) töötleb kaevise tarbimise või võõrandamise lubade ja maavara või maavarana arvele võtmata kivimi ja setendi võtmise lubadega seotud andmeid – sealhulgas taotlusel ja loal kajastatud andmeid – õigusaktides sätestatud kohustuste täitmiseks;

8<sup>6</sup>) töötleb jahipiirkonna kasutusõiguse loaga seotud andmeid – sealhulgas taotlusel ja loal kajastatud andmeid – õigusaktides sätestatud kohustuste täitmiseks;

8<sup>7</sup>) töötleb keskkonnamõju hindamise dokumentidega, mille puhul Keskkonnaamet on otsustaja või järelevalvaja, seotud andmeid;

8<sup>8</sup>) töötleb keskkonnamõju strateegilise hindamise dokumentidega, mille puhul Keskkonnaamet on järelevalvaja, seotud andmeid;

8<sup>9</sup>) töötleb ohtlike jäätmete ja välislepinguga reguleeritavate jäätmete veolubade ja selliste jäätmete riikidevahelise veo, milleks veoluba ei ole vajalik, saatedokumentidega seotud andmeid – sealhulgas taotlusel ja loal kajastatud andmeid – õigusaktides sätestatud kohustuste täitmiseks;
...
1) töötleb keskkonna- ja komplekslubadega ning registreeringutega seotud keskkonnakasutuse aastaaruannete andmeid – õigusaktides sätestatud kohustuste täitmiseks;
...
2<sup>1</sup>) registreeringu taotlustega, registreeringute, keskkonnakasutuse aruannete ja registreerimistõendite alusel tehtava seirega seotud andmed;
...
4<sup>1</sup>) kaevise tarbimise või võõrandamise loa ja maavara või maavarana arvele võtmata kivimi ja setendi võtmise loa taotluste ja lubadega seotud andmed;

5) keskkonnatasudega seotud andmed;

6) käitiste, jäätmekäitluskohtade ning heiteallikate andmed;

7) jahipiirkonna kasutusõiguse loa taotluste ja lubadega seotud andmed;

8) keskkonnamõju hindamise dokumentidega, mille puhul Keskkonnaamet on otsustaja või järelevalvaja, seotud andmed;

9) keskkonnamõju strateegilise hindamise dokumentidega, mille puhul Keskkonnaamet on järelevalvaja, seotud andmed;

10) keskkonnamõju hindamise ja keskkonnamõju strateegilise hindamise juhtekspertide andmed;

11) käesoleva lõike punktides 8 ja 9 nimetatud keskkonnamõju hindamises ja keskkonnamõju strateegilises hindamises osalenud eksperdirühma liikmete andmed;

12) ohtlike jäätmete ja välislepinguga reguleeritavate jäätmete veolubade ja selliste jäätmete riikidevahelise veo, milleks veoluba ei ole vajalik, saatedokumentidega seotud andmed.
...
6<sup>1</sup>) Euroopa Parlamendi ja nõukogu määruse (EÜ) nr 1013/2006 lisades IA, IB ja VII – ohtlike jäätmete ja välislepinguga reguleeritavate jäätmete veolubade ja selliste jäätmete riikidevahelise veo, milleks veoluba ei ole vajalik, saatedokumentide andmed;
...
10<sup>1</sup>) maapõueseaduse §-des 97 ja 99 – kaevise tarbimise või võõrandamise lubade ja maavara või maavarana arvele võtmata kivimi ja setendi võtmise loa taotluste ja lubade andmed;

11) atmosfääriõhu kaitse seaduse § 82 lõike 3 alusel kehtestatud määruses – paikse heiteallika käitaja registreeringu taotluse ja registreerimistõendi andmed;

12) jäätmeseaduse § 98<sup>8</sup> lõigetes 1–3 ja §-s 98<sup>9</sup> – jäätmekäitleja registreeringu taotluse ja registreerimistõendi andmed;

13) tööstusheite seaduse § 134 lõike 4 alusel kehtestatud määruses – orgaanilisi lahusteid kasutava käitise registreerimise taotluse ja registreerimistõendi andmed;

14) veeseaduse § 197 lõike 3 alusel kehtestatud määruses – veekeskkonnariskiga tegevuse registreerimistaotluse ja registreerimistõendi andmed;

15) jahiseaduse §-des 14 ja 15 – jahipiirkonna kasutusõiguse loa taotluse ja loa andmed;

16) keskkonnamõju hindamise ja keskkonnajuhtimissüsteemi seaduse § 11 lõigetes 8 ja 8<sup>1</sup> – keskkonnamõju hindamise algatamise või algatamata jätmise otsuse andmed;

17) keskkonnamõju hindamise ja keskkonnajuhtimissüsteemi seaduse §-s 13 ja § 18 lõikes 3 – keskkonnamõju hindamise programmi ja selle otsuse andmed;

18) keskkonnamõju hindamise ja keskkonnajuhtimissüsteemi seaduse §-s 20, § 20 lõike 2 alusel kehtestatud määruses ja § 22 lõikes 6 – keskkonnamõju hindamise aruande ja selle otsuse andmed;

19) kiirgusseaduse § 69<sup>1</sup> lõike 2 ja § 75<sup>1</sup> lõike 2 alusel kehtestatud – kiirgustegevuse registreeringu taotluse ja registreeringu andmed.
...
3) registreeringu ja loaga seonduva seire aruanne;
...
1) käesoleva määruse § 7 lõikes 1 nimetatud loa (edaspidi *luba*) ja registreeringu taotleja ning teised menetlusosalised;

2) loa ja registreeringu omaja;
...
4) Eesti looduse infosüsteem – veekogude, -kogumite, paisude, suublate ja väljalaskmete andmed;
...
8) ehitisregister – tuuleelektrijaama tehnilised andmed.
...
1<sup>1</sup>) käesoleva määruse § 7 lõikes 1 nimetatud registreering ja sellega seotud andmed – registreeringu kehtivuse lõppemisel;
...
(1) Andmekogusse kantud lubadele ja registreeringutele märgitud füüsilisest isikust loa omaja nimi ja isikukood on avalikud.

(1) Andmekogu avalikus vaates ei näidata loa ja registreeringu taotlusel füüsilisest isikust loa taotleja ega tema kontaktisiku aadressi ja kontaktandmeid.

(1) Andmekogusse kantud keskkonnakasutuse aastaaruannetele märgitud füüsilisest isikust aruande esitaja nimi ning isikukood on avalikud.

(1) Andmekogu avalikus vaates ei näidata füüsilisest isikust keskkonnakasutuse aastaaruande esitaja kontaktandmeid ja koostaja andmeid.

(1) Andmekogusse kantud keskkonnamõju hindamise ja keskkonnamõju strateegilise hindamise juhtekspertide ja eksperdirühma liikmete nimi ning juhteksperdi keskkonnamõju hindamise litsentsi number ja kehtivusaeg on avalik.
