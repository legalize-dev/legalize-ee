...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/101072017031"
...
(1) Andmekogu eesmärk on lihtsustada keskkonnakomplekslubade (edaspidi *kompleksluba*) taotlemist ja menetlemist, kompleksloaga seotud seire-, aruandlus- ja muude kohustuste täitmist ning kogutud andmete säilitamist, kasutamist ja kättesaadavust.
...
(1) Andmekogusse kantakse kompleksloa taotluste, komplekslubade, keskkonnakasutuse aruannete, komplekslubade alusel toimuva seire, kontrollseire, kompleksloa kohustusega käitise korrapärase keskkonnaalase kontrolli ja keskkonnatasudega seotud andmed.
...
1) taotlus kompleksloa saamiseks, kehtetuks tunnistamiseks või muutmiseks;

2) haldusakt kompleksloa andmise, muutmise või kehtetuks tunnistamise kohta;

3) kompleksloaga seonduv käesoleva lõike punktides 1 ja 2 nimetamata menetlusdokument;
...
8) kompleksloaga seonduva seire aruanne;

9) kontrollseire aruanne;

10) keskkonnajärelevalvega seotud dokumendid;

11) muu käesoleva paragrahvi lõikes 1 nimetatud andmetega seotud dokument.

##### § 8. Andmete esitamine

(1) Andmete andmekogusse esitaja on:

1) kompleksloa taotleja ja teised menetlusosalised;
...
(2) Käesoleva määruse § 7 lõikes 1 nimetatud load ja nendega seotud andmed arhiveeritakse loa kehtivuse lõppemisel.
...
(1) Andmekogusse kantud andmed on avalikud seadusega sätestatud ulatuses. Andmekogu andmetele võimaldatakse juurdepääs kooskõlas avaliku teabe seadusega ja isikuandmete kaitse seadusega.
...
(3) Käesoleva seaduse § 8 lõike 1 punktides 1–4 nimetatud andmete esitajatel on juurdepääs üksnes nendega seotud mitteavalikele andmetele.
