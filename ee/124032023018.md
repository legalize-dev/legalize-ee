...
status: "in_force"
source: "https://www.riigiteataja.ee/akt/120012026011"
...
(5) Andmekogu osa on andmeladu, mis koosneb 2. peatükis nimetatud andmetest. Andmelaos säilitatakse andmeid, sealhulgas isikuandmeid, määruse §-s 15 sätestatud tingimustel.
...
16) töökeskkonna andmekogu – välismaalase ja välismaalase kutsujaga või muu isikuga, kelle juurde välismaalane tuleb, seotud andmed, kui välismaalane on lähetatud töötaja Eestisse lähetatud töötajate töötingimuste seaduse tähenduses, samuti andmed tööandja suhtes rakendatud ettekirjutuse ja sunniraha kohta;
...
22) Euroopa reisiinfo ja -lubade süsteem – reisiloa kehtivusaja ja territoriaalse kehtivuse andmed ning alaealise välismaalase puhul tema seadusliku esindaja või muu eestkostja nimi ja kontaktandmed.
