...
1) taotlusperioodil (3 kuud) huviringi osalustasu maksmist tõendav dokument (maksekorraldus või pangakonto väljavõte);
...
3) vähekindlustatud perede puhul perekonna kõigi liikmete toetuseperioodi (3 kuu) netosissetulekut tõendav filtreerimata pangakonto väljavõte.
...
(6) Huvihariduse ja huvitegevuse täiendavat toetust määratakse või keeldutakse selle määramisest Viimsi Vallavalitsuse haridus- ja kultuuriameti juhataja otsusega 15 tööpäeva jooksul arvates taotlusvooru lõppemise tähtajale järgnevast päevast.
