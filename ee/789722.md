...
status: "in_force"
source: "https://www.riigiteataja.ee/akt/119032026006"
...
(1) Haridust tõendavate dokumentide alamregistri andmeid säilitab vastutav töötleja vähemalt 10 aastat, kuid mitte kauem kui 11 aastat alates isiku surmast.

(2) Õpetajate ja akadeemiliste töötajate alamregistrisse kantud andmetest säilitab vastutav töötleja § 18 lõike 1 punktides 1–5, 8–11, 20–23 ja 40 ning lõike 3 punktides 1–8, 10–11<sup>1</sup> ja 13 nimetatud andmeid vähemalt 10 aastat, kuid mitte kauem kui 11 aastat alates isiku surmast. Kõiki teisi §-s 18 nimetatud andmeid säilitab vastutav töötleja vähemalt 25 aastat, kuid mitte kauem kui 26 aastat alates esimese kande tegemisest.

(3) Õpilaste, üliõpilaste ning arst-residentide alamregistrisse kantud andmetest säilitab vastutav töötleja § 26 lõike 1 punktides 1–5, 5<sup>4</sup>, 6, 7<sup>1</sup>, 13–15, 30, 31 ja 38–41 ning lõike 2 punktides 1–4, 8, 12, 13, 19–21, 23–24, 60 ja 65 nimetatud andmeid vähemalt 10 aastat, kuid mitte kauem kui 11 aastat alates isiku surmast. Paragrahvi 26 lõike 1 punktides 5<sup>3</sup>, 11, 23, 35–36, 42 ja 46–53 ning lõike 2 punktides 7, 25, 28, 36, 37, 43–45 ja 61–64 nimetatud andmeid säilitab vastutav töötleja vähemalt 10 aastat, kuid mitte kauem kui 11 aastat alates isiku kohta esimese kande tegemisest. Kõiki teisi §-s 26 nimetatud andmeid säilitab vastutav töötleja kuni 25 aastat alates isiku kohta esimese kande tegemisest.

(3) Koolivalmiduskaardi andmeid säilitatakse kolm aastat alates koolivalmiduskaardi registrisse kandmisest.

(3) Vastuvõtuandmete alamregistri andmeid säilitatakse vastuvõtuandmete alamregistris 12 kuud alates vastuvõtuotsuse tegemise päevast.

(4) Säilitustähtaja möödumisel andmed anonüümitakse.
...
##### § 8<sup>2</sup>. Logiandmed

(1) Registri kande, kande muudatuse ja täienduse tegemise aeg ning kande tegija ees- ja perekonnanimi ning isikukood salvestatakse infosüsteemi logiandmetes. Logiandmetes säilitatakse kandele juurdepääsu aeg, juurdepääsu saaja ees- ja perekonnanimi, isikukood ning andmeobjekt.

(2) Registrikande salvestamise, muutmise ja kustutamise logi säilitatakse vastavalt Eesti Vabariigi haridusseaduses registri andmetele määratud tähtajani. Kannetele juurdepääsu logiandmeid säilitatakse viis aastat.
...
(3) Mikrokvalifikatsioonitunnistuste kohta kantakse haridust tõendavate dokumentide alamregistrisse täiskasvanute koolituse seaduse § 9 lõike 1 alusel kehtestatud standardis loetletud mikrokvalifikatsioonitunnistusele kantavad andmed.

##### § 13. Andmete esitajad ja alusdokumendid

(1) Haridust tõendavate dokumentide alamregistrisse esitavad andmeid põhi-, üldkesk-, kutsekesk- ja kõrghariduse omandamist ning kutseõppe läbimist võimaldavad õppeasutused ning täienduskoolitusasutused, ühisdiplomi korral ühisõppekava koostöölepingus kokku lepitud õppeasutus (käesolevas peatükis edaspidi *õppeasutused*).
...
(7) Paragrahvi 12 lõikes 2 nimetatud andmetest saadakse riigieksamina arvestatavatel rahvusvahelistel võõrkeeleeksamitel saavutatud keeletasemed, riigieksamite punktid ning põhikooli ühtlustatud eksamite tulemused testide andmekogust.
...
2) digitaalne andmebaas kutsehariduse omandamist ja kutseõppe läbimist võimaldavate õppeasutuste õpetajate, direktorite, õppekasvatusala juhtivate töötajate, tugispetsialistide (eripedagoog, logopeed, psühholoog, sotsiaalpedagoog) üle arvestuse pidamiseks;

3) digitaalne andmebaas põhi- ja üldkeskhariduse omandamist võimaldavate õppeasutuste õpetajate, direktorite, õppealajuhatajate, tugispetsialistide (eripedagoog, logopeed, psühholoog, sotsiaalpedagoog) üle arvestuse pidamiseks;

4) digitaalne andmebaas alushariduse omandamist võimaldavate õppeasutuste lapsehoidjate, õpetajate, alushariduse abiõpetajate, direktorite, õppejuhtide, tugispetsialistide (eripedagoog, logopeed, psühholoog, sotsiaalpedagoog) üle arvestuse pidamiseks;
...
(1) Õpetajate ja akadeemiliste töötajate alamregistrisse kantakse andmed alus-, põhi-, üldkesk- ja kutsekeskhariduse omandamist ning kutseõppe läbimist võimaldavate õppeasutuste tasemehariduse pakkumisega seotud õpetajate, haridusasutuste juhtide, tugispetsialistide, lapsehoidjate, alushariduse abiõpetajate ja kõrghariduse omandamist võimaldavate õppeasutuste akadeemiliste töötajate ning huvihariduse omandamist võimaldavate õppeasutuste õppe- ja kasvatustegevusega seotud töötajate kohta. Akadeemilise töötajana käsitatakse kõiki kõrgharidustasemel otseselt õpetamisega tegelevaid isikuid, sealhulgas õpetavaid ning teadus- ja arendustegevust läbiviivaid akadeemilisi töötajaid (eespool ja edaspidi *akadeemiline töötaja*).

##### § 18. Õpetajate ja akadeemiliste töötajate alamregistri andmete koosseis

(1) Õpetajate, haridusasutuste juhtide, tugispetsialistide, lapsehoidjate ja alushariduse abiõpetajate kohta kantakse õpetajate ja akadeemiliste töötajate alamregistrisse järgmised andmed:
...
9<sup>1</sup>) karjääriaste;

9<sup>2</sup>) karjääriastme omistamise kuupäev ja karjääriastme kehtimise lõppkuupäev tähtajaliselt kehtiva karjääriastme puhul;

10) töötamise algus töökohaks olevas õppeasutuses;

11) töötamise lõpp (kuupäev lahkumisel);

12<sup>1</sup>) vanemapuhkus jah/ei;

12<sup>2</sup>) lepingu liik;
...
32) kutsetunnistuse andmed (kutse andja, kutse või osakutse ja kutsetase, kutsetunnistuse registreerimisnumber, kutsetunnistuse väljaandmise kuupäev, kutsetunnistuse kehtivusaja lõpukuupäev);
...
(7) Alushariduse õpetajate, abiõpetajate, lapsehoidjate ja haridusasutuste juhtide kohta kantakse alamregistrisse lõike 1 punktides 1–5, 8–11, 12<sup>1</sup>, 12<sup>2</sup>, 16, 17, 19–29, 32 ja 34–36 nimetatud andmed.

(9) Lõike 1 punktis 39 nimetatud andmed kantakse alamregistrisse ainult üldhariduse õpetajate ja haridusasutuste juhtide puhul.

(10) Nooremteadurite kohta kantakse alamregistrisse lõike 3 punktides 1–5 ja 7–14 nimetatud andmed.

(11) Lõike 1 punktides 9<sup>1</sup> ja 9<sup>2</sup> nimetatud andmed kantakse alamregistrisse ainult üldhariduse õpetajate ja kutseõpetajate puhul.
...
(1) Paragrahvi 18 lõike 1 punktis 32 nimetatud andmed saadakse infosüsteemide andmevahetuskihi kaudu kutseregistrist.

(1) Paragrahvi 18 lõike 1 punktis 34 nimetatud andmed saadakse infosüsteemide andmevahetuskihi kaudu testide andmekogust.
...
8) astme omistamist tõendav dokument.

(2) Akadeemiliste töötajate puhul ei kuulu alusdokumentide hulka lõike 1 punktides 4 ja 6–8 nimetatud dokumendid.
...
(2) Alus-, põhi-, üldkesk-, kutsekesk- ja kõrghariduse omandamist ning kutseõppe läbimist võimaldavad õppeasutused uuendavad §-s 18 toodud andmeid nende muutumise päeval, välja arvatud iga aasta septembris, kui nimetatud andmed esitatakse viie tööpäeva jooksul, ning välja arvatud § 18 lõike 3 punktides 15, 15<sup>1</sup> ja 16 toodud andmed, mis esitatakse kord aastas 10. novembriks. Paragrahvi 18 lõike 1 punktis 40 nimetatud andmed saadakse ristkasutuse teel karistusregistrist.

(3) Huvi-, alus-, põhi-, üldkesk- ja kutsekeskhariduse omandamist ning kutseõppe läbimist võimaldavad õppeasutused kinnitavad õpetajate, alushariduse abiõpetajate, lapsehoidjate, tugispetsialistide ja haridusasutuste juhtide andmete õigsust alamregistris iga kuu (välja arvatud juuli ja august) 5.–10. kuupäeval.
...
5<sup>3</sup>) rahvastikuregistri järgne aadress;
...
7<sup>2</sup>) doktorandiga õppe- ja teadustöö kava täitmiseks töölepingu sõlminud või doktorandi õppe- ja teadustöö kava täitmist finantseeriva juriidilise isiku nimi ja registrikood;

7<sup>3</sup>) doktorandiga õppe- ja teadustöö kava täitmiseks sõlmitud töölepingu või finantseerimislepingu sõlmimise ja lõppemise kuupäev;

7<sup>4</sup>) doktoriõppe õppe- ja teadustöö kava algus- ja lõpukuupäev;
...
20<sup>1</sup>) iseseisva töö osakaal õppekava rakenduskava põhi- ja üldõpingute moodulite kogumahust;
...
44<sup>1</sup>) märge õppimiskohustust täitva õpilase väljalangemisohu kohta;

44<sup>2</sup>) väljalangemisohus oleva õpilase seadusliku esindaja rahvastikuregistrisse kantud elukoht, lisa-aadress ja kontaktandmed;
...
45) märge õppimiskohustust täitva õpilase väljalangemisohu kohta;

45<sup>1</sup>) väljalangemisohus oleva õpilase seadusliku esindaja rahvastikuregistrisse kantud elukoht, lisa-aadress ja kontaktandmed;
...
65) lastehoiust ja lasteaiast väljaarvamise kuupäev ja alus;

65<sup>1</sup>) koolivalmiduskaart;
...
(1) Paragrahvi 26 lõike 1 punktides 2–5, 5<sup>2</sup>, 5<sup>3</sup> ja 44<sup>2</sup> ning lõike 2 punktides 2–4, 6–8 ja 45<sup>1</sup> nimetatud andmed saadakse andmevahetuskihi kaudu rahvastikuregistrist või isiku avalduse alusel.
...
3<sup>1</sup>) doktorandi õppe- ja teadustöö kava;

3<sup>2</sup>) doktorandiga õppe- ja teadustöö kava täitmiseks sõlmitud tööleping või doktorandi õppe- ja teadustöö kava täitmist finantseeriva juriidilise isikuga sõlmitud koostööleping;
...
12) lastehoidu ja lasteaeda vastuvõtmise otsus;
...
(3) Lastehoiud, lasteaiad ja üldhariduskoolid kinnitavad andmete õigsust alamregistris iga kuu (välja arvatud juuli ja august) 5.–10. kuupäevaks.
...
(1) Õppeasutuste alamregistri asutamise ning kasutusele võtmise eesmärk on pidada arvestust alus-, põhi-, üldkesk-, kutsekesk-, kõrg- ja huvihariduse omandamist ning kutseõppe, täienduskoolituse või residentuuri läbimist võimaldavate õppeasutuste üldandmete ning õppe- ja kasvatustööks vajaliku inventari üle ning koolitusloa, majandustegevusteate ja tegevusloa või õppe läbiviimise õiguse ja täienduskoolituse õppekavarühma kvaliteedihindamise positiivse otsuse olemasolu kontrollimiseks.
...
59) arvutite arv õpetajate / akadeemiliste töötajate kasutuses (v.a lastehoid ja lasteaed);

60) arvutite arv lasteaias õpetajate/laste kasutuses kokku;

61) arvutite arv õpilaste/üliõpilaste kasutuses (v.a lastehoid ja lasteaed);

62) interneti allalaadimiskiirus (vahemikud);

63) nutiseadmete arv õpetajate / akadeemiliste töötajate kasutuses (v.a lastehoid ja lasteaed);

64) nutiseadmete arv õpilaste/üliõpilaste kasutuses (v.a lastehoid ja lasteaed);

65) nutiseadmete arv lastehoius ja lasteaias õpetajate kasutuses kokku;

66) testide andmekogu e-testide ja turvalise testimise keskkonda kasutada võimaldavate arvutite arv;
...
71) andmed täienduskoolitusasutuse õppekavarühma kvaliteedi hindamise positiivse otsuse kohta.
...
27) lastehoius ja lasteaias lastevanemate rahastatava osa kogumaht lapse kohta aasta keskmisena kuus;

28) lastehoiu ja lasteaia rühmaruumide pindala;

33) normatiivne kohtade arv lastehoius ja lasteaias;
...
1) koolitusloa, tegevusloa, registreeringu või õppe läbiviimise õiguse andmise või täienduskoolituse õppekavarühma kvaliteedihindamise otsus;
...
(1) Õppeasutused ning huvikooli, noorte- ja projektlaagri pidajad esitavad andmeid õppeasutuste alamregistrisse digitaalallkirjastatult failiga või vastutava töötleja veebilehel asuva viida kaudu üle turvakanali ligipääsetavasse süsteemi. Andmete esitajad identifitseeritakse ID-kaardi abil. Juurdepääsuõiguse registrile vormistab registri vastutav töötleja.

(2) Õppeasutused ning huvikooli, noorte- ja projektlaagri pidajad esitavad andmed õppeasutuste alamregistrisse nende muutumise päeval.

(3) Õppeasutused (välja arvatud huvikoolid) kinnitavad andmete õigsust õppeasutuste alamregistris iga aasta 5.–10. septembriks ning 20.–25. jaanuariks. Käesolevas lõikes sätestatud korda ei kohaldata täienduskoolitusasutusele.

(4) Huvikoolide kohta kantakse alamregistrisse § 35 lõike 1 punktides 1–16 nimetatud andmed.

(5) Alusharidust võimaldavate õppeasutuste kohta kantakse alamregistrisse § 35 lõike 1 punktides 1, 3, 5, 7–11, 13–16, 18, 58, 60, 62 ja 65 ning lõike 2 punktides 25–28, 33 ja 39–41 nimetatud andmed.
...
(11) Täienduskoolitusasutuste kohta kantakse alamregistrisse § 35 lõike 1 punktides 1–5, 10, 11 ja 13–16 nimetatud andmed. Tasemehariduse omandamist võimaldavad õppeasutused, mis on alamregistrisse kantud, ei pea nimetatud andmeid uuesti esitama. Täienduskoolitusasutus kannab iga aasta 31. märtsiks alamregistrisse § 35 lõike 1 punktis 70 nimetatud andmed.
...
(6) Täiskasvanute koolituse seaduse § 12<sup>2</sup> punktis 1 nimetatud juhul kantakse õppekavade ja koolituslubade alamregistrisse mikrokvalifikatsiooniõppe õppekava kohta järgmised andmed:

1) täienduskoolitusasutuse nimi;

2) õppekava nimetus;

3) õppekava nimetus (inglise keeles);

4) rahvusvahelise ühtse hariduse liigituse ISCED õppekavarühm;

5) õppekava kood;

6) õppe kogumaht (ainepunktides);

7) õppekava kinnitamise kuupäev õppeasutuses;

8) õppe liik (mikrokvalifikatsioon, mikrokraad);

9) õppekeel;

10) õpiväljundid;

11) õppekava registrisse kandmise kuupäev või tegevusloa kehtivuse algus;

12) tegevusloa tähtaeg;

13) registreeringu või tegevusloa number;

14) õppekava koondfail;

15) viide vastavale kutsestandardile või selle osale ja tasemele kvalifikatsiooniraamistikus, kui mikrokvalifikatsiooniõpe on suunatud kutsestandardi kutse- või erialaste kompetentside omandamisele.

(7) Täiskasvanute koolituse seaduse § 12<sup>2</sup> punktides 2 ja 3 nimetatud juhul kantakse õppekavade ja koolituslubade alamregistrisse loakohustusega mikrokvalifikatsiooniõppe tegevusloa ja õppekava kohta järgmised andmed:
...
7) õppekava koondfail;

8) tegevusloa liik;

9) tegevusloa andnud majandushaldusasutuse nimetus ning selle juhi või volitatud isiku nimi;

10) tegevusloa kontrolliesemesse kuuluvate majandustegevuse nõuete täitmist tõendavad dokumendid;

11) tegevusloa kehtivuse algus;

12) tegevusloa kehtivuse lõpp;

13) tegevusloa andmise otsuse kuupäev;

14) tegevusloa andmise otsuse number.

(8) Õppekavade ja koolituslubade alamregistrisse kantakse õppekavarühma kvaliteedihindamise positiivse otsuse kohta järgmised andmed:

1) otsuse number;

2) otsuse kuupäev;

3) otsuse kehtivuse algus ja lõpp.
...
1) õppeasutuse nimi ja registrikood;
...
6) tegevusloa väljaandja;

7) lastehoiu või lasteaia asutamise otsus;

8) tegevusloa andmise otsuse kuupäev;

9) tegevusloa andmise otsuse number;

10) tegevuskohad aadressi täpsusega.
...
(1) Õppeasutused ning huvikooli, täienduskoolitusasutuse, noorte- ja projektlaagri pidajad esitavad andmeid õppekavade ja koolituslubade alamregistrisse digitaalallkirjastatult failiga või vastutava töötleja veebilehel asuva viida kaudu üle turvakanali ligipääsetavasse süsteemi.
...
(3) Koolitusloa, tegevusloa, registreeringu, õppe läbiviimise õiguse või täienduskoolituse õppekavarühma kvaliteedihindamise andmed kantakse registrisse pärast asjaomase loa andmist või otsuse tegemist.
...
(1) Kutseõppe õppekava, välja arvatud ettevalmistava õppe õppekava, registreerimise taotlemiseks esitab kutseõppeasutus või rakenduskõrgkool, ühisõppekava korral ühisõppekava hoidjana tegutsev õppeasutus elektrooniliselt alamregistrisse järgmised dokumendid:

1) õppekava koondfail;

2) õppekava põhiõpingute moodulite ja üldpädevuste vastavustabel;

3) kutsestandardis esitatud kompetentsusnõuete ja õppekava põhiõpingute moodulite vastavustabel;
...
(2) Ettevalmistava õppe õppekava registreerimiseks esitab kutsehariduse omandamist võimaldav õppeasutus taotluse ning õppekava hiljemalt kolm kuud enne planeeritavat õppetöö algust elektroonilises alamregistris. Ühisõppekava puhul esitatakse ka ühisõppekava koostööleping.
...
##### § 41<sup>5</sup>. Alus-, põhi- ning üldkeskhariduse omandamist võimaldavate õppeasutuste koolituslubade ja tegevuslubade taotlusdokumentide esitamise ja menetlemise kord ning alushariduse omandamist võimaldavate munitsipaalõppeasutuste asutamise andmete esitamine

(1) Eraomandis olevad põhi- ning üldkeskhariduse omandamist võimaldavad õppeasutused esitavad tegevusloa taotlemiseks erakooliseaduse § 5<sup>4</sup> lõikes 2 nimetatud dokumendid ja andmed elektrooniliselt alamregistrisse. Registri vastutav töötleja kontrollib esitatud andmete vastavust õigusaktidele 2 kuu jooksul alates taotluse esitamisest. Juhul kui eraõppeasutuse õppekavale tehakse ekspertiis, pikeneb taotluse menetlemise aeg kuni 2 kalendrikuu võrra.

(1) Eraomandis olevad alushariduse omandamist võimaldavad õppeasutused esitavad tegevusloa taotlemiseks alusharidusseaduse § 22 lõikes 4 või § 43 lõikes 4 nimetatud dokumendid ja andmed alamregistrisse. Registri vastutav töötleja kontrollib esitatud andmete vastavust õigusaktidele kahe kuu jooksul alates taotluse esitamisest.

(2) Munitsipaalomandis oleva alushariduse omandamist võimaldava õppeasutuse asutamise, ümberkorraldamise ja lõpetamise kohta kannab andmed asutamise otsuse kohta alamregistrisse vastutav töötleja pärast vastava teavituse saamist.
...
##### § 41<sup>8</sup>. Mikrokvalifikatsiooniõppe õppekava esitamise, täienduskoolituse õppekavarühma kvaliteedihindamise taotlemise ja mikrokvalifikatsiooniõppe läbiviimiseks tegevusloa taotlemise ning tegevusloa ja õppekava muutmise kord

(1) Täiskasvanute koolituse seaduse § 12<sup>2</sup> punktis 1 nimetatud õppeasutus esitab mikrokvalifikatsiooniõppe õppekava registrisse vastavalt sama seaduse § 12<sup>3</sup> lõikele 2. Käesoleva määruse § 40 lõikes 2 nimetatud komisjon kontrollib õppekava vastavust õigusaktidele kahe kuu jooksul õppekava esitamisest arvates.

(2) Täiskasvanute koolituse seaduse § 12<sup>2</sup> punktides 2 ja 3 nimetatud õppeasutus esitab taotluse täienduskoolituse õppekavarühma kvaliteedihindamiseks vastavalt sama seaduse §-le 12<sup>9</sup> ja tegevusloa taotluse vastavalt sama seaduse §-le 12<sup>5</sup>.

(3) Õppekava või tegevusloa muutmisel esitab õppeasutus taotluse õppekava või tegevusloa muutmiseks ja muudetud õppekava. Õppeasutuse taotlus vaadatakse läbi ühe kuu jooksul taotluse esitamisest arvates.
...
(2) Alushariduse omandamist võimaldavad õppeasutused kannavad alamregistrisse § 39 lõike 9 punktides 1–3, 7 ja 10 nimetatud andmed.
...
(7) Täienduskoolitusasutus kannab alamregistrisse § 39 lõikes 3 nimetatud andmed. Loakohustusega täienduskoolitust läbiviiva täienduskoolitusasutus kannab alamregistrisse § 39 lõike 4 punktides 1–5 ja 7 nimetatud andmed.
...
### 7<sup>2</sup>. peatükk VASTUVÕTUANDMETE ALAMREGISTER

##### § 42<sup>8</sup>. Vastuvõtuandmete alamregistri pidamise eesmärk

(1) Alamregistri pidamise eesmärk on:

1) võimaldada kandidaadil esitada avaldusi õppeasutusse õppima asumiseks;

2) anda õppeasutustele, õppeasutuste pidajatele ja riigile ning kohaliku omavalitsuse üksusele teavet kandidaatide õpeasutusse vastuvõtmise ja õpingute jätkamise kohta;

3) kontrollida tasuta õppimise õigust;

4) anda teavet haridusstatistika ja uuringute tegemiseks ning hariduse strateegiliseks juhtimiseks.

##### § 42<sup>9</sup>. Vastuvõtuandmete alamregistri andmete koosseis

(1) Vastuvõtuandmete alamregistrisse kantakse järgmised andmed:

1) õppeasutuses vastuvõtuks avatud õppekava andmed;

2) õppeasutuses vabade vastuvõetavate kohtade arv, vajaduse korral info, kui õppekoht on tasuline;

3) õppeasutuse vastuvõtutingimused;

4) kandidaadi üldandmed: isikukood või sünniaeg, ees- ja perekonnanimi ning kontaktandmed;

5) alaealise kandidaadi eestkostja või esindaja andmed: isikukood või sünniaeg, kodakondsus, ees- ja perekonnanimi ning kontaktandmed;

6) vastuvõttu korraldava õppeasutuse vastuvõtutingimuste täitmiseks esitatav info kandidaadi kohta;

7) kandidaadi või esindaja tahteavaldus(ed), sealhulgas andmed õppeasutuse ning õppekava kohta, kuhu vastuvõttu taotletakse, ja õppekoha vastuvõtu kinnitus;

8) vastuvõtutingimuste täitmise tulemused, millest moodustub pingerida;

9) õppeasutuse vastus kandidaadi avaldusele;

10) muud vastuvõtu protsessis vajalikud andmed.

##### § 42<sup>10</sup>. Vastuvõtuandmete alamregistrisse andmete esitajad ja andmete alamregistrisse kandmise kord

(1) Andmed õppeasutuses avatava vastuvõtu kohta, sealhulgas vabade kohtade arv, vastuvõtu tingimused ja vastuvõtutingimuste täitmise tulemused, kannab registrisse õppeasutus.

(2) Andmed kandidaadi, vajaduse korral tema esindaja kohta esitab isik ise või saadakse andmed infosüsteemide andmevahetuskihi kaudu rahvastikuregistrist.
...
(4) Vastuvõttu korraldava õppeasutuse vastuvõtutingimuste täitmiseks esitatavad kandidaadi andmed, nt riigieksamite punktid ning põhikooli ühtlustatud eksamite tulemused võib pärida eksamite infosüsteemist.
...
(6) Andmeid esitatakse vastuvõtuandmete alamregistrisse elektroonilise keskkonna kaudu või infosüsteemide andmevahetuskihi X-tee vahendusel. Andmete esitamisel elektroonilises keskkonnas identifitseeritakse andmete esitajad riigi autentimisteenuse või HarID abil.

(7) Õppeasutuse esindaja juurdepääsuõiguse alamregistrile vormistab registri vastutav töötleja.

##### § 42<sup>11</sup>. Juurdepääs vastuvõtuandmete alamregistri andmetele ja andmete väljastamine

(1) Kohaliku omavalitsuse üksusel on seaduses ja selle alusel antud õigusaktis sätestatud ülesannete täitmise eesmärgil ja ulatuses õigus pääseda juurde alamregistri andmetele või saada neist väljavõtteid.

(2) Tehniliste võimaluste olemasolul tagab registri vastutav töötleja kohaliku omavalitsuse üksuse õppimiskohustusega isikute seiramise ülesande täitmiseks elektroonilise keskkonna või X-tee teenuse andmete edastamiseks.

(3) Kohaliku omavalitsuse üksuse esindaja juurdepääsuõiguse alamregistri andmetele vormistab registri vastutav töötleja.

(4) Kandidaadil on juurdepääs teda puudutavatele andmetele vastuvõtuandmete alamregistri elektroonilise keskkonna kaudu.
