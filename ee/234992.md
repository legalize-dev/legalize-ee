...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/116122022022"
...
rt_year: "2022"
rt_article: "22"
rt_reference: "116122022022"
effective_from: "2023-01-01"
effective_until: "2023-02-12"
...
(1) Aktsiisikauba import käesoleva seaduse mõistes on aktsiisikauba vabasse ringlusse lubamine tolliseadustiku mõistes.
...
(1) Aktsiisikauba eksport käesoleva seaduse mõistes on aktsiisikaubale ekspordi tolliprotseduuri rakendamine tolliseadustiku mõistes.
...
(2) Aktsiisikauba kaugmüügil maksab aktsiisi maksuesindaja maksukorralduse seaduse mõistes. Kui kaugmüüjal ei ole maksuesindajat, maksab aktsiisi kauba füüsilisest isikust vastuvõtja.
...
7<sup>1</sup>) maksuesindaja või kaugmüügil aktsiisikauba vastuvõtja;

7<sup>2</sup>) registreeritud kaubasaaja ja käesoleva seaduse §-s 21<sup>1</sup> nimetatud isik;
...
(18) Käesoleva seaduse § 21<sup>1</sup> lõikes 1 nimetatud juhul tekib aktsiisi maksmise eest vastutaval isikul maksukohustus teisest liikmesriigist lähetatud aktsiisikauba põhjendamata kaolt selle tekkimise päeval või, kui põhjendamata kao tekkimise päeva ei ole võimalik kindlaks teha, siis põhjendamata kao avastamise päeval.
...
(2) Nõukogu rakendusmäärusega (EL) nr 282/2011, millega sätestatakse ühist käibemaksusüsteemi käsitleva direktiivi 2006/112/EÜ rakendusmeetmed (ELT L 77, 23.03.2011, lk 1–22), kehtestatud käibemaksust ja aktsiisist vabastamise tõendit kohaldatakse käesoleva paragrahvi lõike 1 punktides 1–1<sup>2</sup>, 29 ja 30 sätestatud juhtudel, kui aktsiisikaup soetatakse aktsiisilaost. Käesoleva lõike esimeses lauses nimetatud tõendit ei nõuta käesoleva paragrahvi lõikes 2 nimetatud juhul, samuti käesoleva paragrahvi lõike 1 punktides 1<sup>1</sup> ja 1<sup>2</sup> nimetatud relvajõudude vee- ja õhusõidukite tankimise korral Eestis vahetult selle aktsiisilaopidaja või laevavarustaja poolt, kelle tegevuskoht ning vee- ja õhusõidukite tankimiskoht asuvad sama lennuvälja, kopteriväljaku või sadama territooriumil. Käesoleva lõike esimeses lauses nimetatud tõendit ei nõuta käesoleva paragrahvi lõike 1 punktides 1<sup>1</sup> ja 1<sup>2</sup> nimetatud relvajõudude õhusõidukite tankimise korral Eestis vahetult kaitseväe aktsiisilao poolt.
...
(1) Käesoleva seaduse §-s 21<sup>1</sup> nimetatud isik esitab tagatise teises liikmesriigis tarbimisse lubatud aktsiisikaubalt aktsiisi maksmise tagamiseks selle toimetamisel Eestisse.
...
5) käesoleva seaduse §-s 21<sup>1</sup> nimetatud isiku puhul samaaegselt talle veetava aktsiisikauba suurimalt koguselt.
...
(1) Käesoleva seaduse §-s 21<sup>1</sup> nimetatud isik on kohustatud:
...
3) Maksu- ja Tolliametile on SADHESi kaudu esitatud aktsiisikauba saatedokument, millel on aktsiisikauba saaja, kellel tekkis aktsiisi maksmise kohustus, kinnitus aktsiisikauba vastuvõtmise kohta või maksuesindaja kinnitus aktsiisikauba kättetoimetamise kohta teises liikmesriigis;
...
(1) Õlle aktsiisimäär on 12,70 eurot õlle etanoolisisalduse ühe mahuprotsendi kohta hektoliitris.
...
(2) Kääritatud joogi ja veini, mille etanoolisisaldus on kuni kuus (kaasa arvatud) mahuprotsenti, aktsiisimäär on 63,35 eurot kääritatud joogi või veini hektoliitri kohta.
...
(6) Muu alkoholi aktsiisimäär on 18,81 eurot muu alkoholi etanoolisisalduse ühe mahuprotsendi kohta hektoliitris.
...
4) registreeritud kaubasaaja või käesoleva seaduse §-s 21<sup>1</sup> nimetatud isiku poolt alkoholi võõrandamisel, kui alkoholile ei kohaldata aktsiisivabastust;
...
(5) Alkoholi peab Eestis maksumärgistama aktsiisilaos või tollilaos. Käesoleva seaduse §-s 21<sup>1</sup> nimetatud isiku tegevuskohas ja registreeritud kaubasaaja tegevuskohas on teisest liikmesriigist Eestisse toimetatud alkoholi maksumärgistamine lubatud, kui alkoholile kinnitamiseks kasutatavad maksumärgid on isiku valduses hiljemalt alkoholi tegevuskohta vastuvõtmise päeval ning maksumärgid kinnitatakse tootele viivitamata. Alkoholi müügipakendilt maksumärgi eemaldamine ja uuega asendamine on lubatud vaid aktsiisilaos või tollilaos.
...
(12) Registreeritud kaubasaaja ja käesoleva seaduse §-s 21<sup>1</sup> nimetatud isik võivad maksumärgistamata alkoholi võtta teisest liikmesriigist vastu üksnes juhul, kui nad on sellele alkoholile maksumärkide tellijad.
...
(1) Sigarettide aktsiisimäär koosneb fikseeritud määrast 1000 sigareti kohta ja sigarettide maksimaalse jaehinna alusel arvutatud proportsionaalsest määrast. Fikseeritud määr on 96,30 eurot ja proportsionaalne määr 30 protsenti sigarettide maksimaalsest jaehinnast.

(1) Sigarettidelt makstakse aktsiisi käesoleva paragrahvi lõikes 1 sätestatud määra alusel, kuid mitte vähem kui 160,50 eurot 1000 sigareti kohta.
...
3<sup>1</sup>) registreeritud kaubasaaja või käesoleva seaduse §-s 21<sup>1</sup> nimetatud isiku poolt tubakatoote võõrandamisel, kui tubakatootele ei kohaldata aktsiisivabastust;
...
(4) Tubakatooteid peab Eestis maksumärgistama aktsiisilaos või tollilaos. Käesoleva seaduse §-s 21<sup>1</sup> nimetatud isiku tegevuskohas ja registreeritud kaubasaaja tegevuskohas on teisest liikmesriigist Eestisse toimetatud tubakatoodete, välja arvatud alternatiivsed tubakatooted, maksumärgistamine lubatud, kui tubakatoodetele kinnitamiseks kasutatavad maksumärgid on isiku valduses hiljemalt tubakatoodete tegevuskohta vastuvõtmise päeval ning maksumärgid kinnitatakse tubakatoodetele viivitamata. Tubakatootelt maksumärgi eemaldamine ja uuega asendamine on lubatud vaid aktsiisilaos või tollilaos.
...
(11) Registreeritud kaubasaaja ja käesoleva seaduse §-s 21<sup>1</sup> nimetatud isik võivad maksumärgistamata tubakatooteid võtta teisest liikmesriigist vastu üksnes juhul, kui nad on nende tubakatoodete maksumärkide tellijad.
...
(3) Maksumärkide tellija teatab Maksu- ja Tolliametile maksumärkide tellimisel sigarettide, sigarite või sigarillode maksimaalse jaehinna.
...
(7) Kerge kütteõli aktsiisimäär on 372 eurot 1000 liitri kerge kütteõli kohta.
...
(10) Maagaasi aktsiisimäär on 40 eurot 1000 m<sup>3</sup> maagaasi kohta.

(10) Mootorimaagaasi aktsiisimäär on 40 eurot 1000 m<sup>3</sup> mootorimaagaasi kohta.

(10) Veeldatud olekus mootorimaagaasi aktsiisimäär on 55,79 eurot 1000 kilogrammi nimetatud kütuse kohta.
...
(12) Elektrienergia soodusaktsiisimäär on riigiabi komisjoni määruse (EL) nr 651/2014 artikli 44 tähenduses ning selle andmisel järgitakse nimetatud määruses ja konkurentsiseaduse §-s 34<sup>2</sup> sätestatut. Riigiabiga seotud andmed on avalik teave. Majandus- ja Kommunikatsiooniministeerium esitab riigiabi ja vähese tähtsusega abi registrile andmed elektrointensiivsele ettevõtjale antud riigiabi kohta vastavalt konkurentsiseaduse § 49<sup>2</sup> lõikele 3.
