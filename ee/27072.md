...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/107062022011"
...
(1) Tervishoiutöötajate registri asutab ja selle põhimääruse kehtestab
...
(5) Andmeid tervishoiutöötajate kohta säilitatakse tervishoiutöötajate registris 30 aastat pärast isiku surma. Logisid ja alusandmeid hoitakse vastavalt tervishoiutöötajate registri põhimääruses sätestatule.
...
(1) Tervishoiuteenuse osutamise tegevuslubade riikliku registri asutab ja selle põhimääruse kehtestab
...
(2) Tervishoiuteenuse osutamise tegevuslubade riiklikus registris töödeldakse järgmisi andmeid:
...
(2) Tervishoiuteenuse osutamise tegevuslubade riikliku registri andmeid säilitatakse tegevusloa kehtivuse või majandustegevuse lõppemisest 30 aastat. Logisid ja alusandmeid säilitatakse vastavalt registri põhimääruses sätestatule.
