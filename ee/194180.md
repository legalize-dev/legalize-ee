...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/130032021006"
...
(2) Eestis registreeritud või registreeritava laeva kohta väljastab meresõiduohutust tõendavad tunnistused ja mõõtekirja Transpordiamet.
...
(4) Transpordiamet tunnustab rahvusvaheliste konventsioonide ja käesoleva seaduse nõuetele vastavaid volitatud klassifikatsiooniühingu väljastatud tunnistusi ja mõõtekirja ning isiku tegevusluba, kes valmistab tooteid või osutab teenuseid käesoleva seaduse §-s 7 nimetatud tegevusvaldkonnas.

(5) Transpordiamet tunnustab Euroopa Liidu liikmesriigi väljastatud tunnistusi ja mõõtekirja ning isiku tegevusluba, kes valmistab tooteid või osutab teenuseid käesoleva seaduse § 7 punktides 1–5 ja 13 nimetatud tegevusvaldkonnas, kui need vastavad rahvusvaheliste konventsioonide ja käesoleva seaduse nõuetele.
...
(1) Kui laeval on laevaagent, siis märgib laeva kapten laevaagendi nime lootsikviitungile ja Transpordiametile esitatavale laeva ülddeklaratsioonile.
...
(2) Volitatud klassifikatsiooniühing, kellega Transpordiamet on sõlminud vastava lepingu, võib läbi viia reederi ja tema laeva meresõiduohutusalast auditeerimist ning selle edukalt läbinud reederile ja tema laevale väljastada sellekohased tunnistused.
...
(3) Transpordiamet tunnustab volitatud klassifikatsiooniühingu väljastatud meresõiduohutusalase auditeerimise tunnistusi, kui need vastavad rahvusvaheliste konventsioonide ja käesoleva seaduse nõuetele.
...
(6) Transpordiameti poolse reederi ja laeva meresõiduohutusalase auditeerimise ja auditeerimisele eelneva dokumentatsiooni läbivaatamise eest tasub reeder riigilõivu kümne tööpäeva jooksul pärast auditeerimise toimumist.
...
(1) Eesti riigilippu kandvalt laevalt võtab turvahäire vastu politseiasutus, teavitades sellest kohe Transpordiametit. Vajaduse korral teavitab Transpordiamet välisriiki, mille läheduses turvahäire edastanud laev asub. Saades teabe välisriigi lippu kandva laeva turvahäire edastamisest, teavitab Transpordiamet sellest kohe laeva lipuriiki ja vajaduse korral välisriiki, mille läheduses turvahäire edastanud laev asub.
...
(3) Eesti riigilippu kandval laeval kehtivast turvatasemest ja turvataseme muutumisest teavitab reederit Transpordiamet.
...
(1) Reeder, kes opereerib I kategooriasse kuuluvaid laevu, peab määrama isiku, kes on läbinud reederi turvaülema koolituse ning kellel on kohustus tagada, et laeval on läbi viidud riskianalüüs ja välja töötatud ning rakendatud laeva turvaplaan. Turvaplaan tuleb kooskõlastada Transpordiametiga.
...
(3) Reeder peab tagama, et II kategooria laevale on koostatud turvajuhend. Turvajuhend tuleb kooskõlastada Transpordiametiga.
...
(1) Kohalikus rannasõidus sõitva laeva turvaõppuse eesmärk on kontrollida laeva turvaplaani tõhusat rakendamist. Laeva turvaõppuseid tuleb korraldada iga kolme kuu tagant, laeva turvaharjutusi vastavalt Transpordiameti nõudmisele.
...
(3) Eestis registreeritud laeva tehnilist järelevalvet teostab Transpordiamet. Lisaks Transpordiametile teostab tehnilist järelevalvet laevale kogumahutavusega 500 või enam, välja arvatud riigihaldusülesandeid täitvale laevale ja siseveelaevale, volitatud klassifikatsiooniühing.
...
(4) Eestis registreeritud laeva tehnilise ülevaatuse teostab Transpordiamet. Laevale, millele volitatud klassifikatsiooniühing väljastab kõik meresõiduohutust tõendavad tunnistused ning millele Transpordiamet on väljastanud meresõiduohutuse korraldamise tunnistuse, ei teosta Transpordiamet merekõlblikkuse tunnistuse või reisijateveo tunnistuse väljastamiseks vajalikku tehnilist ülevaatust.
...
(1) Eestis registreeritava või registreeritud ehitatava või ümberehitatava laeva tehniline dokumentatsioon tuleb esitada Transpordiametile läbivaatamiseks ning kooskõlastamiseks enne ehitamise alustamist.
...
(6) Kui Transpordiamet kooskõlas käesoleva seaduse § 3 lõigetega 1 ja 2 väljastab laeva kohta kõik rahvusvahelise konventsiooniga inimelude ohutusest merel ettenähtud tunnistused või väljastab kalalaevale § 19 lõike 5 kohaselt kalalaeva vastavuse tunnistuse, ei väljasta Transpordiamet selle laeva kohta merekõlblikkuse tunnistust.
...
(1) Transpordiamet tunnistab meresõiduohutust tõendava tunnistuse või sõidukõlblikkuse tunnistuse kehtetuks:
...
2) kui laev või selle seade on vigastatud selliselt, et kahjustab laeva merekõlblikkust või sisevetel sõidukõlblikkust, ning kui vigastus ei ole kõrvaldatud Transpordiameti või volitatud klassifikatsiooniühingu ettekirjutatud viisil.
...
(2) Transpordiamet teostab riiklikku järelevalvet laevade projekteerimise, ehitamise ja seadistamise üle.

(3) Transpordiamet tunnustab volitatud klassifikatsiooniühingu pädevust teostada järelevalvet laevade projekteerimise, ehitamise ja seadistamise üle, kui see vastab rahvusvaheliste konventsioonide ja käesoleva seaduse nõuetele.
...
(6) Transpordiamet võib klassifitseerimata laevade puhul käesoleva seaduse 3., 4., 5., 7. ja 10. peatüki sätted jätta kohaldamata või kohaldada osaliselt, kui on tagatud laeva ohutus. Sellisel juhul arvestab Transpordiamet laeva püstuvust, konstruktsiooni, sõidupiirkonda ja sõidupiirkonna hüdrometeoroloogilist eripära.
...
(4) Mereõppeasutus esitab Transpordiametile käesoleva seaduse § 7 punktis 8 nimetatud tegevuseks tegevusloa saanud isiku läbiviidud kvaliteedisüsteemi välisauditi aruande ühe kuu jooksul välisauditi läbiviimisest arvates, kui auditeerijaks ei ole Transpordiamet. Kvaliteedisüsteemi esmane sõltumatu välisaudit peab olema läbi viidud kolme kuu jooksul koolitustegevuse algusest või teadmiste ja oskuste hindamisest arvates.

(5) Transpordiamet teostab mereõppeasutuse tunnustamist ja järelevalvet väljaõppe vastavuse üle käesoleva seaduse ning meremeeste väljaõppe, diplomeerimise ja vahiteenistuse aluste rahvusvahelise konventsiooni nõuetele.

(5) Transpordiamet väljastab meresõidudiplomi või kutsetunnistuse isikule, kes on läbinud koolituse käesoleva seaduse § 7 punktis 11 nimetatud tegevuseks tegevusloa saanud mereõppeasutuses või sellise välisriigi mereõppeasutuses, mille meremeeste väljaõppe korraldus on IMO poolt tunnustatud, arvestades käesoleva paragrahvi lõikes 5<sup>3</sup> sätestatut.
...
(3) Laeva juhtkonna liikme meresõidudiplomi ja kutsetunnistuse juurde kuulub Transpordiameti väljastatud kinnitusleht, mis annab õiguse töötada kinnituslehel märgitud ametikohal.
...
(6) Reisilaeva miinimumkoosseis peab hädaolukorras tagama reisijate ohutuse ja evakueerimise. Reeder esitab miinimumkoosseisu kehtestamiseks Transpordiametile häireplaani ning korraldab laeval Transpordiameti järelevalveametnike osavõtul õppuse.
...
(1) Meremeeste registrit peab Transpordiamet.
...
(1) Reisijateveo tunnistus või reisilaeva ohutuse tunnistus kaotab kehtivuse või Transpordiamet tunnistab reisijateveo tunnistuse või reisilaeva ohutuse tunnistuse kehtetuks käesoleva seaduse § 18 kohaselt.
...
(2) Vajaduse korral väljastab Transpordiamet teisaldatava registreerimismärgi. Teisaldatava registreerimismärgi võib väljastada väikelaevu ja alla 12-meetrise kogupikkusega laevu valmistavale või uute väikelaevade ja alla 12-meetrise kogupikkusega laevade hulgi- ja jaemüügi õigusega ettevõtjale.
...
9) enne 2004. aasta 1. maid kasutusele võetud väikelaeval puuduvad nõuetekohased dokumendid ja ehitaja paigaldatud plaat või puudub Transpordiameti väljastatud käesoleva seaduse § 36 lõikes 6 nimetatud kontrollakt.
...
(2) Väikelaeva juhi teadmiste, oskuste ja väljaõppe nõuded, tunnistuste vormid ja nende väljastamise korra kehtestab
...
(2) Eesti riigilippu kandval laeval, mille kogumahutavus on 20 ja enam, peab olema Transpordiameti kinnitatud püstuvuse informatsioon.

(3) Last tuleb paigutada ja kinnitada reederi väljatöötatud ning Transpordiameti kooskõlastatud juhendi kohaselt. Juhendit ei nõuta tahke või vedela mahtlasti veol. Välisriigi lippu kandval laeval peab olema selle riigi pädeva asutuse poolt kooskõlastatud lasti paigutamise ja kinnitamise juhend.

(4) Transpordiamet tunnustab volitatud klassifikatsiooniühingu kinnitatud püstuvuse informatsiooni ning kooskõlastatud lasti paigutamise ja kinnitamise juhendit, kui see vastab rahvusvaheliste konventsioonide ja käesoleva seaduse nõuetele.
...
(2) Käesoleva paragrahvi lõikes 1 nimetatud laevadele väljastatakse pärast laeva ülevaatust AFS-konventsiooni nõuete täitmise kohta kattumisvastase süsteemi rahvusvaheline tunnistus. Klassifitseerimata laevadele väljastab kattumisvastase süsteemi tunnistuse Transpordiamet ja klassifitseeritud laevadele väljastab kattumisvastase süsteemi rahvusvahelise tunnistuse volitatud klassifikatsiooniühing.
...
(45) Alkoholijoobes olevaks loetakse väikelaeva või muu veesõiduki juht järgmistel juhtudel:
...
(45) Väikelaeva või muu veesõiduki omanikul on õigus kehtestada väiksem lubatud alkoholisisalduse määr või alkoholi tarbimise keeld.
...
(9) Üldkasutataval veeteel on selliseks veeliiklust takistavaks tegevuseks, mis ei ole reguleeritud rahvusvahelise laevakokkupõrgete vältimise eeskirja konventsiooni nõuetega või sisevetel liiklemise korraga, vaja Transpordiameti luba. Laevateel on veeliiklust takistavaks tegevuseks vaja Transpordiameti luba. Loa saamiseks esitab tegevuse korraldaja vähemalt 30 päeva enne kavandatud tegevuse algust Transpordiametile kirjaliku taotluse, milles on näidatud kavandatud tegevus ning selle läbiviimise piirkond ja aeg. Transpordiamet väljastab loa või keeldub loa väljastamisest ja teatab loa andmata jätmise põhjused seitsme tööpäeva jooksul taotluse esitamisest arvates. Loa andmisel teavitab Transpordiamet vajaduse korral veeliiklejaid veeliiklust takistavast tegevusest. Transpordiamet keeldub loa väljastamisest, kui kavandatav tegevus ohustab meresõiduohutust või turvalisust.
...
(4) Üldkasutataval veeteel korraldab navigatsioonimärgistuse ja laevateede projekteerimist, rajamist ning haldamist Transpordiamet. Laevatee paiknemisest, selle parameetritest ja märgistusest ning nende muutustest teavitab veeliiklejaid Transpordiamet.
...
(1) Transpordiamet võib vabastada laeva käesoleva seaduse § 53<sup>3</sup> lõigete 1–3 kohasest sadamasse saabumisest teavitamise nõudest. Erandi tegemisele kohaldatakse käesoleva seaduse §-s 42<sup>1</sup> sätestatud nõudeid ja korda.
...
(1) Käesoleva paragrahvi lõike 1 punktis 1 nimetatud sadamateenuste osutamisega seotud laeva reeder peab vabastuse saamiseks teatama Transpordiametile ja käesoleva seaduse § 56 lõikes 1 nimetatud lootsiteenuse osutajale laeva nime, IMO numbri, lipuriigi ja kogumahutavuse vähemalt viis tööpäeva enne nimetatud laevaga sadamateenuse osutamise alustamist sadamas.
...
(1) Transpordiamet keeldub lootsitasõidu loa väljaandmisest ja selle kehtivusaja pikendamisest, kui:
...
(1) Lootsimispiirkonna või muu kutsetunnistuse tingimuse muutmiseks tuleb esitada Transpordiametile asjakohane taotlus.
...
(2) Transpordiamet keeldub lootsi kutsetunnistuse kehtivusaja pikendamisest, kui taotleja ei soorita lootsi kvalifikatsioonieksamit.
...
1) kontrollima enne laevale saabumist laeva süvist ja vabaparrast ning juhul, kui laev on lastitud üle laadungimärgiga lubatud piiri või üle sadama eeskirjaga lubatud suurima süvise, teatama sellest Transpordiametile;

2) esitama kaptenile tema nõudmisel lootsi kutsetunnistuse;

3) tutvuma laeva kontroll-lehega. Kui loots avastab, et laeva seisund erineb kontroll-lehe sissekannete kohasest seisundist ja laeva tegelik seisund vähendab meresõiduohutust, on ta kohustatud sellest viivitamata teatama tööandjale, kes peab lootsi avastatud puudused tegema kohe teatavaks Transpordiametile;
...
7) teatama esimesel võimalusel oma tööandjale, Transpordiametile ja sadamakaptenile meresõitu ohustavast muutusest või takistusest lootsimispiirkonnas;

8) teatama esimesel võimalusel oma tööandjale, Transpordiametile ja sadamakaptenile lootsitava laevaga juhtunud õnnetusest või vigastusest, mille on lootsitav laev tekitanud teisele veesõidukile, sadamaehitisele, hüdrotehnilisele rajatisele või navigatsioonimärgile;

9) teatama oma tööandjale, Transpordiametile ja sadamakaptenile merereostusest.
...
(3) Kui kapteni tegevus lootsimise piirkonnas on kehtiva korraga vastuolus, peab loots nõudma rikkumise kohest lõpetamist. Kapteni keeldumise korral peab loots sellest viivitamata teatama oma tööandjale, Transpordiametile ja sadamakaptenile.
...
(1) Volitatud klassifikatsiooniühingu ning volitatud turvalisusorganisatsiooni tegevuse üle teostab riiklikku järelevalvet Transpordiamet.

(2) Transpordiameti pädevuses on riiklik järelevalve laevade tehnilise seisukorra, ohutuse ja turvalisuse üle, deklareeritud sügavuste, navigatsioonimärgistuse ja muude rajatiste navigatsiooniteabele vastavuse üle ning Transpordiametilt tegevusloa saanud ettevõtja tegevuse üle kõigil loakohustusega tegevusaladel. Transpordiameti, politseiasutuse ning muu seaduses sätestatud järelevalveasutuse järelevalveametniku pädevuses on riiklik järelevalve väikelaevade ja jettide üle.

(2) Transpordiamet teostab riiklikku järelevalvet laevaremondi üle klassifitseerimata laevadel.
...
(3) Transpordiameti järelevalveametniku ametitõendi vormi kehtestab

. Järelevalveametniku ametitõendi väljastab Transpordiamet.
...
(7) Transpordiameti järelevalveametniku ametipalga määraks on riigiteenistujate ühtse palgaastmestiku kõrgeima astme palgamäär.
...
(9) Transpordiameti järelevalveametniku vormiriietuse kirjelduse ja eraldusmärgid kehtestab
...
(5) Kui laeval on keelatud sadamast väljuda, on Transpordiamet kohustatud sellest viivitamata teatama politseile ja sadamakaptenile.
...
(2) Transpordiameti järelevalveametnik märgib puuduse ja selle kõrvaldamise tähtaja laevakontrolli akti. Laeva kinnipidamise korral märgitakse laevakontrolli akti ka viited seaduse või muu õigusakti sättele, mida rikuti.
...
(4) Laeva sadamasse sisenemise keelust teavitab Transpordiamet viivitamata kirjalikult laeva kaptenit ja reederit. Transpordiamet edastab sadamasse sisenemise keelu otsuse koopia laeva lipuriigi pädevale asutusele, asjaomasele klassifikatsiooniühingule ja turvalisusorganisatsioonile, Paris MOU liikmesriikidele, Euroopa Liidu liikmesriikidele, Euroopa Komisjonile ja Paris MOU sekretariaadile ning sisestab andmed keelu kohta viivitamata laevakontrolli andmebaasi ja teabesüsteemi.
...
(1) Navigatsioonimärkide ja laevaliiklust reguleerivate signaalmärkide Transpordiametiga kooskõlastamata paigaldamise või ümberpaigutamise või navigatsioonimärkide kavandamise, rajamise, paigaldamise, muutmise või märgistusest teavitamise nõuete või korra rikkumise eest –
...
(1) Lootsimisel oma tööandjale, Transpordiametile või sadamakaptenile lootsimispiirkonnas meresõitu ohustavatest muutustest või takistustest või lootsitava laevaga juhtunud laevaõnnetusest või merereostusest teatamata jätmise eest –
