...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/130102020001"
...
(1) Vedurijuhiloa vormistab ja annab isikule Maanteeamet Tarbijakaitse ja Tehnilise Järelevalve Ameti otsuse alusel.

(2) Vedurijuhiloa saamiseks peab isik sooritama Maanteeametis vedurijuhieksami.
...
(4) Vedurijuhiluba kehtib kümme aastat. Enne nimetatud tähtaja möödumist tuleb vedurijuhiluba uuendada. Vedurijuhiloa uuendamiseks peab vedurijuht Maanteeametis edukalt sooritama vedurijuhieksami.
...
(6) Maanteeameti pädevuses on raudtee-ettevõtjatele kehtestatud nõuete täitmise kontrollimine, arvestades käesoleva seaduse §-s 7 sätestatut.
...
(2) Majandus- ja Kommunikatsiooniministeeriumi, Maanteeameti ning Tarbijakaitse ja Tehnilise Järelevalve Ameti riiklikku järelevalvet tegeval ametiisikul on õigus oma tööülesannete täitmisel sõita veduri ja reisirongiga tasuta.
...
##### § 147. Majandus- ja Kommunikatsiooniministeeriumi, Tarbijakaitse ja Tehnilise Järelevalve Ameti, Konkurentsiameti, Maanteeameti ja Tööinspektsiooni õigus teabele ning juurdepääs järelevalveobjektidele

(1) Raudtee-ettevõtja ja tema töötajad, muu raudteeinfrastruktuuri ja raudteeveeremi omanik või valdaja ja tema töötajad, raudtee-ettevõtjaga samasse kontserni kuuluv ettevõtja ja tema töötajad, samuti raudteeveeremi tehnohoolde või remondiga tegelev ettevõtja ja tema töötajad on kohustatud valdkonna eest vastutavale ministrile või tema poolt selleks volitatud ametnikule, Tarbijakaitse ja Tehnilise Järelevalve Ametile, Konkurentsiametile, Maanteeametile ning Tööinspektsioonile nende esimesel nõudmisel andma riikliku järelevalve ülesannete täitmiseks vajalikku tõest ja täielikku teavet.
...
(1) Majandus- ja Kommunikatsiooniministeerium, Tarbijakaitse ja Tehnilise Järelevalve Amet, Konkurentsiamet, Tööinspektsioon, Riigi Infosüsteemide Amet ning Maanteeamet on kohustatud tagama neile riikliku järelevalve tegemisel teatavaks saanud äri- ja tehnikaalase teabe konfidentsiaalsuse, kui seadus ei näe ette selle avaldamist.
...
(3) Käesoleva seaduse §-des 167–170 sätestatud väärtegude kohtuväline menetleja on Maanteeamet.
...
##### § 177. Atmosfääriõhu kaitse seaduse muutmine

Atmosfääriõhu kaitse seaduse § 206 lõikes 5 asendatakse sõna „Raudteeveo-ettevõtja” sõnaga „Raudteeveoettevõtja”.

##### § 178. Ehitusseadustiku muutmine

Ehitusseadustikus tehakse järgmised muudatused:

**1)** paragrahvi 87 tekst muudetakse ja sõnastatakse järgmiselt:

„Raudteerajatise kasutamisele ja korrashoiule kohaldatakse lisaks käesoleva seadustiku nõuetele ka raudteeseadusest tulenevaid nõudeid.”;
...
**3)** paragrahvi 88 täiendatakse lõikega 3 järgmises sõnastuses:

„(3) Raudteerajatise projekteerimistingimused tuleb kooskõlastada puudutatud kohaliku omavalitsuse üksusega.”;

**4)** paragrahvi 89 tekst muudetakse ja sõnastatakse järgmiselt:

„Raudteerajatise ehitamiseks esitatakse Tarbijakaitse ja Tehnilise Järelevalve Ametile ehitusteatis või annab Tarbijakaitse ja Tehnilise Järelevalve Amet ehitusloa.”;

**5)** paragrahvi 90 tekst muudetakse ja sõnastatakse järgmiselt:

„Raudteerajatise kasutamiseks esitatakse Tarbijakaitse ja Tehnilise Järelevalve Ametile kasutusteatis või annab Tarbijakaitse ja Tehnilise Järelevalve Amet kasutusloa.”;

**6)** seadustiku lisa 1 raudteerajatiste osa muudetakse ja sõnastatakse järgmiselt:
„

”;

**7)** seadustiku lisa 2 raudteerajatiste osa muudetakse ja sõnastatakse järgmiselt:
„

”.

##### § 179. Keskkonnavastutuse seaduse muutmine

Keskkonnavastutuse seaduse § 8 lõike 2 punktis 5 asendatakse arv „66” arvuga „111”.

##### § 180. Riigilõivuseaduse muutmine

Riigilõivuseaduses tehakse järgmised muudatused:

**1)** paragrahvi 157 punktis 1 asendatakse tekstiosa „raudteeinfrastruktuuri” tekstiosaga „avaliku raudteeinfrastruktuuri”;

**2)** paragrahvi 157 punktis 2 asendatakse tekstiosa „raudtee reisijateveoteenuse osutamiseks” tekstiosaga „reisijateveoga avalikul raudteel tegelemiseks”;

**3)** paragrahvi 157 punktis 3 asendatakse tekstiosa „raudtee kaubaveoteenuse osutamiseks” tekstiosaga „kaubaveoga avalikul raudteel tegelemiseks”;

**4)** paragrahvi 157 punktid 4–6 tunnistatakse kehtetuks;

**5)** paragrahvi 209 lõiked 1 ja 2 muudetakse ning sõnastatakse järgmiselt:
...
**6)** paragrahvi 209 lõiget 3 täiendatakse teise lausega järgmises sõnastuses:

„Kui nimetatud toimingut taotletakse elektrooniliselt Tarbijakaitse ja Tehnilise Järelevalve Ameti e-teenuste infosüsteemi kaudu, tasutakse riigilõivu 28 eurot.”;

**7)** paragrahvi 209 lõiget 4 täiendatakse teise lausega järgmises sõnastuses:

„Kui nimetatud toimingut taotletakse elektrooniliselt Tarbijakaitse ja Tehnilise Järelevalve Ameti e-teenuste infosüsteemi kaudu, tasutakse riigilõivu 68 eurot.”;

**8)** paragrahvi 210 pealkiri muudetakse ja sõnastatakse järgmiselt:

„**§ 210. Registreerimistunnistuse väljastamine**”;

**9)** paragrahvid 211 ja 212 muudetakse ning sõnastatakse järgmiselt:
...
Allsüsteemi kasutuselevõtmise loa, raudteeveeremi turule laskmise loa või raudteeveeremi tüübiloa taotluse läbivaatamise eest tasutakse riigilõivu 4160 eurot.
...
**10)** paragrahvis 213 asendatakse arv „63” arvuga „107”;

**11)** seaduse 8. peatüki 6. jao 6. jaotist täiendatakse §-dega 213<sup>1</sup> ja 213<sup>2</sup> järgmises sõnastuses:

„**§ 213<sup>1</sup>. Tegevusloa taotluse läbivaatamine**

Tegevusloa taotluse läbivaatamise eest tasutakse riigilõivu lähtuvalt tegevusloa liigist järgmiselt:
...
Hoolduse eest vastutava üksuse sertifikaadi taotluse läbivaatamise eest tasutakse riigilõivu 4300 eurot.”;

**12)** seaduse 8. peatüki 6. jao 7. jaotist täiendatakse §-ga 215<sup>12</sup> järgmises sõnastuses:

„**§ 215<sup>12</sup>. Raudteerajatise projekteerimistingimuste taotluse läbivaatamine**

Raudteerajatise projekteerimistingimuste taotluse läbivaatamise eest tasutakse riigilõivu 25 eurot.”;

**13)** paragrahvi 331<sup>2</sup> lõikest 1 ja § 331<sup>4</sup> lõikest 1 jäetakse välja tekstiosa „Raudteerajatise,”.

##### § 181. Raudteeseaduse kehtetuks tunnistamine

Raudteeseadus (RT I 2003, 79, 530) tunnistatakse kehtetuks.
