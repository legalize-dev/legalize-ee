...
status: "in_force"
source: "https://www.riigiteataja.ee/akt/128012026007"
...
(1) Asjaõiguse kinnistusraamatusse kandmisel võib õiguse sisu täpsustamiseks viidata kinnistusraamatu kande tegemise aluseks olevatele dokumentidele ja andmetele, kui seaduses ei ole sätestatud teisiti.
...
(1) Kinnisasja koormava asjaõiguse lõpetamiseks on nõutav õigustatud isiku notariaalselt tõestatud avaldus õiguse lõpetamise kohta ja õiguse kustutamine kinnistusraamatust, kui seadus ei sätesta teisiti. Avaldus tuleb anda kinnistusosakonda või isikule, kelle kasuks õigus lõpetatakse.
...
(1) Kinnisasja omanik võib kinnisomandist loobuda. Riik ja kohaliku omavalitsuse üksus kinnisomandist loobuda ei või.

(1) Isikul ei ole õigust kinnisomandist loobuda, kui:

1) ta on jätnud täitmata kinnisasjaga seotud kohustused, mis tulenevad detailplaneeringust, ohutus- ja keskkonnanõuetest või haldusorgani ettekirjutusest;

2) kinnisasi on koormatud hüpoteegiga;

3) kinnistu kohta on kinnistusregistriosa kolmandasse jakku kantud isiklik kasutusõigus, kasutusvaldus, märge üürilepingu kohta või kinnistu omaniku käsutusõiguse kitsendus;

4) kinnisasjale on püstitatud ebaseaduslik ehitis või ehitise dokumendid ei vasta nõuetele või dokumentides kajastatud ehitis puudub;

5) tema suhtes on alustatud pankroti- või likvideerimismenetlus;

6) kinnisomandi üle on käimas kohtumenetlus.

(2) Tehing, millega kinnisomandist loobutakse, peab olema notariaalselt tõestatud. Käesoleva paragrahvi 1<sup>1</sup>. lõike punktides 1 ja 4 nimetatud asjaolude esinemise või puudumise kohta esitab kinnisasja asukoha järgne kohaliku omavalitsuse üksus notarile tõendi kahe kuu jooksul vastava päringu saamisest arvates. Seda tähtaega võib vajaduse korral pikendada kuni kahe kuu võrra.

(3) Kui kinnisomandist on loobutud, läheb kinnisomand üle kinnisasja asukoha järgsele kohaliku omavalitsuse üksusele alates tema kinnisasja omanikuna kinnistusraamatusse kandmisest, välja arvatud käesoleva paragrahvi 5. lõikes sätestatud juhul. Kohaliku omavalitsuse üksuse kui puudutatud isiku nõusolek ei ole sellise kande tegemiseks vajalik.
...
(5) Kui kinnisomandist loobub kinnisasja kaasomanik, läheb tema kaasomandi osa üle teistele kaasomanikele vastavalt nende kaasomandi osa suurusele. Sellisel juhul ei kohaldata käesoleva paragrahvi 1<sup>1</sup>. lõiget.

(6) Käesolevas paragrahvis kinnisomandist loobumise kohta sätestatu kehtib ka korteriomandist loobumise kohta.
...
##### § 132<sup>1</sup>. Kinnisomandi ulatus avalikus veekogus tekkinud kinnisasjale

(1) Avalikus veekogus tekkinud iseseisev kinnisasi on riigi omandis.
...
(1) Kui hüpoteegipidaja hüpoteegist loobub, omandab hüpoteegi koormatud kinnisasja omanik. Loobumiseks tuleb teha hüpoteegipidaja notariaalselt kinnitatud või digitaalselt allkirjastatud avalduse alusel kanne kinnistusraamatusse.

(2) Kui hüpoteegipidaja loobub hüpoteegist osaliselt, kohaldatakse § 349 2. lõike sätteid.

##### § 330. Hüpoteegi lõpetamine

(1) Hüpoteegi lõpetamiseks on vajalik hüpoteegipidaja notariaalselt kinnitatud või digitaalselt allkirjastatud avaldus ja kinnisasja omaniku notariaalselt kinnitatud või digitaalselt allkirjastatud nõusolek. Nõusolek tuleb avaldada kinnistusosakonnale või hüpoteegipidajale. Nõusolek ei ole tagasivõetav.
