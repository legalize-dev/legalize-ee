...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/122032021014"
...
(1) Käesoleva seaduse § 71 lõikes 10 sätestatud juhtudel paneb Sotsiaalkindlustusamet erihoolekandeteenust saama õigustatud isiku tema toetusvajadusele vastava teenuse järjekorda alates erihoolekandeteenuse osutamise otsuse tegemise kuupäevast, koostades sellekohase nimekirja.
...
2) täisealisel isikul on puuetega inimeste sotsiaaltoetuste seaduse alusel tuvastatud raske või sügav puue;
...
(3) Lisaks käesoleva paragrahvi lõigetes 1 ja 2 nimetatud täisealistele isikutele on õigus saada ööpäevaringset erihooldusteenust täisealisel isikul, välja arvatud käesoleva seaduse § 72 lõikes 2 nimetatud täisealisel isikul, kellel on sügav liitpuue ja:

1) kes vastab käesoleva paragrahvi lõike 1 punktides 4, 5 ja 6 sätestatud tingimustele;

2) kellel on tuvastatud töövõimetoetuse seaduse alusel puuduv töövõime, välja arvatud riikliku pensionikindlustuse seaduse §-s 7 sätestatud vanaduspensioniikka jõudnud täisealise isiku puhul, ja

3) kellel on puuetega inimeste sotsiaaltoetuste seaduse alusel tuvastatud sügav puude raskusaste.

(4) Sügava liitpuudega täisealiseks isikuks ööpäevaringse erihooldusteenuse tähenduses loetakse täisealist isikut, kellel on raske või sügav vaimne alaareng ja lisaks muu puue puuetega inimeste sotsiaaltoetuste seaduse § 2 lõike 1 tähenduses.
...
3) tagama teenust saavate täisealiste isikute turvalisuse, ohutuse ja ettenähtud teenuse osutamise, kui ööpäevaringset erihooldusteenust osutatakse käesoleva seaduse § 101 lõikes 1 nimetatud täisealistele isikutele, sügava liitpuudega täisealistele isikutele ja ebastabiilse remissiooniga raske, sügava või püsiva kuluga psüühikahäirega täisealistele isikutele samades ruumides;
...
(7) Kui ööpäevaringset erihooldusteenust osutatakse ainult vaimse alaarenguga täisealistele isikutele, sealhulgas kohtumäärusega hoolekandeasutusse paigutatud vaimse alaarenguga täisealistele isikutele, tagab teenuseosutaja iseseisva õendusabi kättesaadavuse 40 teenust saava vaimse alaarenguga täisealise isiku kohta vähemalt 40 tundi nädalas.

(8) Ööpäevaringset erihooldusteenust, välja arvatud majutamist, võib kohtumäärusega hoolekandeasutusse paigutatud täisealistele isikutele osutada käesoleva seaduse § 101 lõikes 1 nimetatud täisealiste isikutega, sügava liitpuudega täisealiste isikutega ja ebastabiilse remissiooniga raske, sügava või püsiva kuluga psüühikahäirega täisealiste isikutega samades ruumides ja samal ajal, arvestades käesoleva seaduse §-s 103 sätestatut.
...
3) kohtumäärusega hoolekandeasutusse paigutatud täisealine isik ei sea ohtu ennast või teisi täisealisi isikuid.
...
(2) Kui ööpäevaringset erihooldusteenust osutatakse ebastabiilse remissiooniga raske, sügava või püsiva kuluga psüühikahäirega või sügava liitpuudega psüühikahäirega täisealisele isikule, tagab ööpäevaringse erihooldusteenuse osutaja 15 nimetatud teenust saava täisealise isiku kohta vähemalt ühe tegevusjuhendaja ööpäevaringse kohaloleku ning vastavalt täisealiste isikute vajadustele lisaks vähemalt ühe tegevusjuhendaja kohaloleku väljaspool ööaega.
...
1) isiku üldandmed – isikukood, sugu, sünniaeg, perekonna- ja eesnimi, elukoha- ja kontaktandmed;
