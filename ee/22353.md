...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/13099867"
...
(17) Kinnistusraamatu, samuti laevakinnistusraamatu märke tehinguväärtus on märkega tagatud nõude väärtus. Kui avaldus märke seadmiseks on ühes ja samas dokumendis märkega tagatava nõude tekkimise aluseks oleva tehinguga, siis märke tehinguväärtust ei määrata.
...
(37) Reaalkoormatise tehinguväärtus on reaalkoormatise aastaväärtuste summa, kuid mitte rohkem kui 25 aasta eest. Minimaalne aastaväärtus on 1000 krooni.
...
(40) Ostueesõiguse seadmisel on tehinguväärtus veerand kinnisasja tehinguväärtusest.
...
(44) Vahetuslepingu tehinguväärtus on kõrgema väärtusega vahetatava objekti väärtus.

##### § 17<sup>1</sup>. Elatise maksmise kokkuleppe tehinguväärtus

(45) Elatise maksmise kokkuleppe tehinguväärtus on makstava elatise summa, kuid mitte rohkem kui ühe aasta eest.

##### § 17<sup>2</sup>. Loosimise ja liisuheitmise tehinguväärtus

(46) Loosimise ja liisuheitmise tehinguväärtus on vastavalt väljaloositava asja või õiguse või liisuheitmise eseme väärtus.

##### § 17<sup>3</sup>. Varaloendi tehinguväärtus

(47) Varaloendi tehinguväärtus on loendisse kantud vara väärtus.

##### § 17<sup>4</sup>. Enampakkumise tehinguväärtus

(48) Enampakkumise tehinguväärtus on enampakkumise eseme väärtus.
...
(1) Annakusaaja tunnistuse väljastamise tehinguväärtus on tunnistusel märgitud annakuks määratud eseme väärtus.

(1) Sundosa saaja tunnistuse väljastamise tehinguväärtus on tunnistusel märgitud sundosa summa.
...
(64) Tehinguväärtuse alusel arvutatakse notari tasu käesolevas paragrahvis toodud tehinguväärtuste ja täistasude tabeli järgi.
...
(65) Kui käesoleva seaduse muudest sätetest ei tulene teisiti, on notari tasu tehingu tõestamise eest:
...
(66) Notari tasu kaasomandis oleva vara jagamise ja kasutuskorra kindlaksmääramise lepingu ning ühisvara jagamise lepingu tõestamise eest on ühekordne täistasu.

##### § 25. Kinnistamisavalduse tõestamine

(67) Kui kinnistamisavalduse, sealhulgas laevakinnistamisavalduse aluseks olev võlaõiguslik tehing on eelnevalt juba notariaalselt tõestatud, on notari tasu kinnistamisavalduse või kinnistatud laeva omandiõiguse ülemineku kokkuleppe tõestamise eest 50 krooni. Kui kinnistamisavaldus on ühes dokumendis vastava võlaõigusliku tehinguga, siis kinnistamisavalduse tõestamise eest tasu ei võeta.

##### § 26. Eluruumi erastamise lepingu tõestamine

(68) Notari tasu eluruumi erastamise lepingu tõestamise eest on 1% tehinguväärtusest, kuid mitte vähem kui 100 krooni ning mitte rohkem, kui on notari tasu, lähtudes käesoleva seaduse §-s 22 sätestatud tehinguväärtuste ja täistasude tabelist.

##### § 27. Volituse tõestamine

(69) Notari tasu volituse tõestamise eest on pool täistasust, kuid mitte vähem kui 50 krooni füüsilise isiku volituse, 100 krooni juriidilise isiku või asutuse volituse puhul.
...
(74) Notari tasu loosimise läbiviimise ja tõestamise eest on kahekordne ning liisuheitmise läbiviimise ja tõestamise eest ühekordne täistasu, kuid mitte vähem kui 750 krooni toimingu kestuse aja iga tunni eest.

##### § 28<sup>3</sup>. Varaloendi koostamine ja tõestamine

(75) Notari tasu varaloendi koostamise ja tõestamise eest on ühekordne täistasu, kuid mitte vähem kui 750 krooni toimingu kestuse aja iga tunni eest.
...
1<sup>1</sup>) annakusaaja tunnistuse väljastamise eest;

1<sup>2</sup>) sundosa saaja tunnistuse väljastamise eest, kuid mitte rohkem kui 500 krooni;2)–3) [Kehtetud –
...
(83) Notari tasu tehingu projekti koostamise eest, kui tehingu tõestamist ei järgne, on pool tehingu tõestamise tasust.

## 4. osa TEHINGUVÄÄRTUSEST MITTESÕLTUV NOTARI TASU

##### § 31. Kindla tasumääraga notariaaltoimingud

(84) Kindla tasumääraga on järgmised notariaaltoimingud:
...
3<sup>1</sup>) avalduse tõestamine pensioni või toetuse teise isiku arveldusarvele kandmiseks –10 krooni;
...
15<sup>1</sup>) avaldaja nimel määruskaebuse koostamine kinnitatud kandeavalduste suhtes tehtud määruste peale, välja arvatud juhul, kui sama notar tõestas ka avalduse aluseks oleva tehingu – 100 kuni 500 krooni;
...
20) pärijate väljaselgitamine ja pärimistunnistuse väljastamine – 800 krooni;
...
24<sup>1</sup>) notariaadiseaduse § 30 lõikes 2

<sup>2</sup>

nimetatud teate või taotluse koostamine – 30 kuni 200 krooni;
...
37) pärimisseaduses sätestatud üleskutsemenetluse läbiviimine – 200 krooni;

38) testamenditäitja ülesande vastuvõtmise või ülesandest loobumise avalduse tõestamine – 100 krooni;

39) testamenditäitja tunnistuse väljastamine – 100 krooni;

40) pärija õiguste ja kohustuste kohta täiendavate järelepärimiste tegemiseks avalduse tõestamine – 100 krooni;

41) pärimismenetluse algatamise avalduse tõestamine – 200 krooni;

42) sundosa saaja tunnistuse väljastamine, kui sellel ei märgita sundosa summat – 100 krooni.
...
(85) Tõendi ja tunnistuse väljaandmise eest on notari tasu määraks tehinguväärtuste ja täistasude tabelis sätestatud minimaalne täistasu, kui käesoleva seadusega ei ole ette nähtud muud tasu määra.
...
(91) Kui notari tasu on määratud ajatasuna, ümardatakse toimingu tegemiseks kulutatud aeg, mis läheb üle täis- või pooltunni, vastavalt pool- või täistunniks.
...
(117) Käesoleva seaduse § 31 punkt 36 jõustub eraldi seadusega Eesti liitumisel Euroopa Liiduga.
