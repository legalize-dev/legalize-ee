...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/13190151"
...
(12) Tehinguväärtuse määramisel on kinnisasja või ehitise minimaalväärtuseks 100 000 krooni, kinnisasja või ehitise mõttelise osa minimaalväärtuseks 20 000 krooni ja kinnisasja või ehitise reaalosa ning selle juurde kuuluva kinnisasja või ehitise mõttelise osa minimaalväärtuseks 60 000 krooni.
...
(37) Reaalkoormatise tehinguväärtus on reaalkoormatise aastaväärtuste summa, kuid mitte rohkem kui 25 aasta eest. Minimaalne aastaväärtus on 4000 krooni.
...
(77) Tõendi ja tunnistuse väljaandmise eest on notari tasu määraks tehinguväärtuste ja täistasude tabelis sätestatud minimaalne täistasu, kui käesoleva seadusega ei ole ette nähtud muud tasu määra.

##### § 33.

##### § 33<sup>1</sup>. Tasu notari ametiteenuste eest

(78) Tasu notariaadiseaduse §-s 32 sätestatud ametiteenuste eest on kokkuleppeline, välja arvatud juhul, kui lepitusteenust osutatakse Notarite Koja lepitus- ja vahekohtu kaudu.
...
(87) Kui notari tasu on määratud ajatasuna, ümardatakse toimingu tegemiseks kulutatud aeg, mis läheb üle täis- või pooltunni, vastavalt pool- või täistunniks.
...
(107) Kui notari poolt tõestatud dokument tuleb notaril tema vea tõttu ümber teha või uuesti tõestada, ei võeta dokumendi ümbertegemise või tõestamise eest notari tasu.

##### § 42. Notari tasu sissenõude aegumine

(108) Notari tasu ja tehtud kulutuste nõude aegumistähtaeg on üks aasta, arvates notariaaltoimingu lõpuleviimise päevast, tehnilise teenuse osutamisest, muu kulu tekkimisest või notari tasu maksmisest vabastamise taotluse kohta tehtud kohtulahendi jõustumisest.

##### § 43. Notari tasu ümberarvutamine

(109) Kui notari tasu suurus pärast arvutusvea avastamist ja ümberarvutamist kujuneb väiksemaks kui esialgne notari tasu, tagastab notar kohustatud isikule enammakstu kohe.
...
(114) Käesoleva seaduse tähenduses ei ole notari tasuks välisesinduste ametiisikute ja valla- ning linnasekretäride poolt tehtavate notariaaltoimingute eest makstav riigilõiv.
...
(116) Käesoleva seaduse § 31 punkt 36 jõustub eraldi seadusega Eesti liitumisel Euroopa Liiduga.
