...
status: "in_force"
source: "https://www.riigiteataja.ee/akt/406022026039"
...
14<sup>1</sup>) resotsialiseerimisteenus;

15) vaimse tervise teenused;
...
(4) Toetus määratakse jooksva aasta või õppeaasta lõpuni.
...
(4) Koduteenust osutab ja korraldab Lääne-Harju Valla Tugikeskus.

(4) Koduteenuse osutamiseks sõlmib, muudab ja lõpetab Lääne-Harju Valla Tugikeskus taotlejaga kirjaliku lepingu, kus määratakse teenuste loetelu ja maht, lähtudes teenusele suunamise haldusaktist.

(5) Koduteenuste osutamise leping kuulub läbivaatamisele lähtuvalt kliendi vajadustest. Täiendused ja muudatused fikseeritakse lepingus ning kinnitatakse poolte allkirjadega.

(6) Koduteenuse tööprotsessid kantakse teenuseosutaja poolt vastavasse hoolekanderakendusse.
...
(2) Teenuse esmakordsel taotlemisel esitab teenust vajav isik sotsiaaltöötajale kirjaliku või suulise taotluse abi vajalikkuse põhjendusega, mis takistavad ühistranspordi kasutamist ning võimalusel transpordi lähte- ja sihtkoht. Isikule abi osutamisel ja teenuse vajaduse väljaselgitamisel kasutatakse juhtumikorralduse põhimõtet.

(2) Kui sõidutellimus on edastatud vähem kui 3 tööpäeva enne teenuse vajadust, siis on õigus keelduda tellimuse täitmisest.

(2) Teenust osutab Lääne-Harju Valla Tugikeskus. Tugikeskus võib vajadusel sõlmida teenuse osutamisel lepingu ka teiste teenuse osutajatega
...
##### § 40. Vaimse tervise teenused

(1) Teenuste eesmärk on toetada ja parandada isiku või perekonna psühhosotsiaalset heaolu ja vaimset tervist.

(2) Teenusteks on psühholoogiline nõustamine, pereteraapia, loovteraapia, kriisinõustamine ja muud vajaduspõhised abimeetmed.

(3) Teenusemahuks on kuni 5 teenustundi. Lisamahu määramine toimub põhjendatud juhtudel ja abivajaduse vahehindamise järgselt.
...
##### § 41<sup>1</sup>. Resotsialiseerimisteenus
