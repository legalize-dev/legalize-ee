...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/119032019013"
...
(8) Veealused mälestised kannab Veeteede Amet koostöös ametiga navigatsioonikaardile.
...
##### § 104. Autoriõiguse seaduse muutmine

Autoriõiguse seaduse § 45 tekst muudetakse ja sõnastatakse järgmiselt:
...
##### § 105. Ehitusseadustiku muutmine

Ehitusseadustikus tehakse järgmised muudatused:

**1)** paragrahvi 26 lõiget 3 täiendatakse punktiga 4 järgmises sõnastuses:

„4) muinsuskaitse eritingimusi, kui need on nõutavad muinsuskaitseseaduse kohaselt.”;

**2)** paragrahvi 27 lõiget 2 täiendatakse punktiga 4 järgmises sõnastuses:

„4) detailplaneeringu muinsuskaitse eritingimusi, kui need on nõutavad muinsuskaitseseaduse kohaselt.”.

##### § 106. Majandusvööndi seaduse muutmine

Majandusvööndi seaduse V<sup>1</sup>. peatükk muudetakse ja sõnastatakse järgmiselt:

„**V<sup>1</sup>. peatükk
VEEALUSE KULTUURIPÄRANDI KAITSE**
...
##### § 107. Muinsuskaitseseaduse kehtetuks tunnistamine

Muinsuskaitseseadus (RT I 2002, 27, 153) tunnistatakse kehtetuks.

##### § 108. Muuseumiseaduse muutmine

Muuseumiseaduses tehakse järgmised muudatused:

**1)** paragrahvi 3 lõikes 2, § 11 lõikes 7, § 15 lõikes 3, §-s 22 ja § 23 lõikes 1 asendatakse sõna „Kultuuriministeerium” sõnaga „Muinsuskaitseamet” vastavas käändes;

**2)** paragrahvi 6 lõikes 2 ja § 15 lõikes 6 asendatakse sõnad „valdkonna eest vastutav minister” sõnaga „Muinsuskaitseamet” vastavas käändes;

**3)** paragrahvi 21 lõike 1 sissejuhatav lauseosa muudetakse ja sõnastatakse järgmiselt:

„Avalik-õigusliku isiku muuseum, munitsipaalmuuseum ja eramuuseum võivad saada tegevustoetust riigieelarvest Kultuuriministeeriumi kaudu ning riigi sihtasutuse muuseum asutajaõigusi teostava ministeeriumi kaudu järgmistel tingimustel:”;

**4)** paragrahvi 21 lõige 4 muudetakse ja sõnastatakse järgmiselt:

„(4) Muuseumide tegevustoetuseks eraldatud vahendite taotlemise ja määramise korra kehtestab valdkonna eest vastutav minister määrusega.”.

##### § 109. Planeerimisseaduse muutmine

Planeerimisseaduses tehakse järgmised muudatused:

**1)** paragrahvi 74 lõige 6 muudetakse ja sõnastatakse järgmiselt:

„(6) Kui planeeritaval maa-alal asub muinsuskaitseala või selle kaitsevöönd, arvestatakse üldplaneeringu koostamisel üldplaneeringu muinsuskaitse eritingimustega, lähtudes muinsuskaitseseaduses sätestatust.”;

**2)** paragrahvi 124 lõige 8 muudetakse ja sõnastatakse järgmiselt:

„(8) Kui planeeritaval maa-alal asub muinsuskaitseala, kinnismälestis või nende kaitsevöönd, arvestatakse detailplaneeringu koostamisel detailplaneeringu muinsuskaitse eritingimusi, lähtudes muinsuskaitseseaduses sätestatust.”.

##### § 110. Riigilõivuseaduse muutmine

Riigilõivuseaduses tehakse järgmised muudatused:

**1)** paragrahv 143 muudetakse ja sõnastatakse järgmiselt:
...
**2)** seaduse 7. peatüki 1. jao 1. jaotist täiendatakse paragrahviga 143<sup>1</sup> järgmises sõnastuses:
...
**3)** paragrahvi 144 tekst muudetakse ja sõnastatakse järgmiselt:
...
##### § 111. Sõjahaudade kaitse seaduse muutmine

Sõjahaudade kaitse seaduses tehakse järgmised muudatused:

**1)** paragrahvi 14 lõike 2 teine lause tunnistatakse kehtetuks;

**2)** paragrahvi 14 lõige 3 tunnistatakse kehtetuks;

##### § 112. Tulumaksuseaduse muutmine

Tulumaksuseaduse paragrahvi 19 lõiget 3 täiendatakse punktiga 18 järgmises sõnastuses:
...
##### § 113. Erastamisest laekuva raha kasutamise seaduse muutmine

Erastamisest laekuva raha kasutamise seaduse § 7 lõiget 1<sup>1</sup> täiendatakse punktiga 7 järgmises sõnastuses:
