...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/413112018008"
...
3) tule- ja plahvatusohtlikke jäätmeid, sh üle 40<sup>o</sup>C kuuma tuhka;
...
(3) Vanapaberi ja papi kogumiseks tuleb kasutada eraldi kogumismahutit elamutes, kus on 5 või enam korterit, ja mitteelamutes, kus tekib nädalas üle 50 kg vanapaberit ja pappi. Vanapaberiks käesoleva eeskirja tähenduses ei loeta dokumente, mis tuleb hävitada vastavalt isikuandmete kaitse seadusele ja arhiiviseadusele.

(4) Biolagunevate köögi- ja sööklajäätmete kogumiseks tuleb kasutada eraldi kogumismahutit elamutes, kus on 19 või enam korterit, ja mitteelamutes, kus tekib nädalas üle 20 kg biolagunevaid köögi- ja sööklajäätmeid või kus tegutseb toitlustusettevõte.

(5) vähem kui 19 korteriga elamutes ei rakendata biolagunevate jäätmete eraldi mahutisse liigiti kogumise kohustust elanikele juhul kui:

1) kinnistul tekkivad biolagunevad jäätmed kompostitakse eeskirja § 33 kohaselt samal kinnistul;

2) segaolmejäätmete konteinerit tühjendatakse vähemalt üks kord kuus sealjuures biolagunevate aia- ja haljastusjäätmed kogutakse eraldi ja antakse üle jäätmekäitlejale või kogumisringil.

(6) Võimaluse korral ja kui see osutub otstarbekaks, tuleb käesoleva paragrahvi lõigetes 3 ja 4 nimetatud jäätmeliike koguda eraldi ka väiksema korterite arvuga elamutes ja väiksema jäätmetekkega mitteelamutes. Seejuures on eraldi kogutud biolagunevad jäätmed soovitatav väikeelamute puhul kompostida oma kinnistul vastavalt eeskirja §-le 33.
...
4) käsitsi teisaldatava kogumismahuti käsitransport jäätmeveokini kuni 10 m;
...
(3) Vallavalitsusel on õigus muuta jäätmeveo teenustasu jäätmevedaja põhjendatud taotluse alusel mitte rohkem kui üks kord kalendriaastas ning mitte varem kui aasta pärast hankelepingu sõlmimist.
...
(1) Jäätmevaldaja loetakse korraldatud jäätmeveoga liitunuks elu- või tegevuskohajärgses jäätmeveo piirkonnas alates kohaliku omavalitsuse üksuse korraldatud jäätmeveo jäätmeloa kehtima hakkamisest. Korraldatud jäätmeveoga liitunud jäätmevaldajal ei ole lubatud anda korraldatud jäätmeveoga hõlmatud jäätmeid üle vedajale, kes ei ole tema piirkonnas korraldatud jäätmeveo teenuse osutaja.
...
(1) Vallavalitsus võib jäätmevaldaja erandkorras kuni kolmeks aastaks vabastada korraldatud jäätmeveoga liitumisest kui:

1) kinnistul ei elata või kinnistut ei kasutata,

2) kinnistut kasutatakse suveperioodil;

3) isikul on kehtiv jäätmeluba/keskkonnakompleksluba.
...
(2) Lammutustegevuseks tuleb ettevõttel taotleda Keskkonnaametist jäätmeseaduse § 74 lõike 1 punktile 3 vastav jäätmekäitleja registreerimistõend.
...
2) jäätmete kogumispunkt aadressil Paide mnt 7j, Tapa.
...
1) Tamsalu Vallavolikogu 17.11.2010 määrus nr 17 “Jäätmehoolduseeskiri”;

2) Tapa Vallavolikogu 29.10.2015 määrus nr 54 „Tapa valla jäätmehoolduseeskiri“,

3) Tamsalu Vallavolikogu 17.11.2010 määrus nr 18 „Tamsalu valla korraldatud olmejäätmeveo piirkonna, jäätmeveoga hõlmatud jäätmeliigi, vedamise sageduse ja -aja, teenustasu piirmäära ning jäätmeveo teenustasu suuruse määramise korra kehtestamine“.
...
| elukoha aadress |  |
| esindaja nimi (juriidilise isiku korral) |  |
| telefon |  |
| e-post |  |
| leevendust/vabastust puudutav kinnistu |  |
| 2. Taotletav tähtaeg | alates: kuni: |
| Üksnes suveperioodil kasutatava maja/suvila korral on võimalik taotleda vaid perioodi 1. oktoober – 30. aprill |  |
| 3. Põhjendus (tähista ristiga sobiv variant) | Kinnistul ei elata või kinnistut ei kasutata Kinnistut kasutatakse suveperioodil Olmejäätmete valdajal on jäätmeluba või saastatuse kompleksse vältimise ja kontrollimise seaduse alusel antud keskkonnakompleksluba |
| KINNITAN esitatud andmete õigsust |  |
| Taotleja või esindaja nimi |  |
| kuupäev | allkiri |

| RESOLUTSIOON (täidab Tapa Vallavalitsus) |  |
| --- | --- |
| Nõustuda / Mitte nõustuda | Tapa Vallavalitsuse „ “ 20 a korraldus nr |
| Ametniku nimi |  |
| kuupäev | allkiri |

📎 [Original PDF: TapaVVK_m39_taotlus2.pdf](https://www.riigiteataja.ee/aktilisa/TapaVVK_m39_taotlus2.pdf)
