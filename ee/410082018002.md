...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/404042025015"
...
(6) Lisaks e-keskkonnas ARNO või paberkandjal esitatavale vastuvõtutaotlusele esitab isik (edaspidi sisseastuja) või piiratud teovõimega sisseastuja puhul lapsevanem koolile hiljemalt 30. augustiks alljärgnevad dokumendid:
...
5) 1. klassi sisseastumisel esitab lapsevanem lasteasutusest väljastatud koolivalmiduskaardi;
...
(7) 10. klassi vastuvõtmise tingimused:
...
3) paremusjärjestuse koostamise põhimõtted, mille kooli direktor on eelnevalt kooskõlastanud vallavalitsusega, avaldatakse kooli kodulehel;

4) õpilase põhikooli lõputunnistusele kantud käitumis- ja aastahinded peavad olema vähemalt rahuldavad;

5) õpilased, kelle kolme ühtse põhikooli lõpueksami keskmine tulemus on 75 protsenti või rohkem, on vabastatud vestluse nõudest;

6) vestluse eesmärk on välja selgitada õpilase huvid ja motiveeritus pühenduda gümnaasiumiõpingutele;

7) võrdsete koondtulemuste korral arvestatakse põhikooli lõpueksamite keskmist;

8) vabade kohtade olemasolul korraldab kool täiendava vastuvõtu;

9) vestluste ajad ja vastuvõtmise tingimused koos selgitustega avaldatakse kooli kodulehel hiljemalt 1. märtsiks.
...
1) kui õpilane või piiratud teovõimega õpilase vanem on koolile esitanud sellekohase taotluse läbi e-keskkonna ARNO või vajadusel paberkandjal kooli direktorile;
