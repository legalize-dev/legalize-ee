...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/121032011019"
...
(1) Majandusvööndis on mereuuringu tegija kohustatud:
...
### V<sup>1</sup>. peatükk KULTUURIMÄLESTISTE KAITSE

##### § 13<sup>1</sup>. Õiguslikud alused

(1) Veealuste kultuurimälestiste kaitset teostatakse vastavuses Eesti Vabariigi välislepingutega, muinsuskaitseseadusega ja teiste Eesti õigusaktidega.

##### § 13<sup>2</sup>. Isikute kohustused

(1) Kõik majandusvööndis tegutsevad juriidilised ja füüsilised isikud peavad hoiduma tegevustest, mis võivad kahjustada veealuseid kultuurimälestisi või nende kaitsevööndeid ning sellise tegevuse ilmnemisel teatama kohe pädevale riigiasutusele.
...
(1) Majandusvööndis kalavarude ebaseadusliku uurimise, püügi, kogumise või kasutamise või merekeskkonna reostamise, samuti majandusvööndisse tehissaarte, rajatiste või muu seadmestiku paigutamise või sellise seadmestiku või meresõidu ohutuse tagamise eeskirjade rikkumise eest –
...
(1) Käesoleva seaduse §-s 16<sup>1</sup> sätestatud väärteole kohaldatakse karistusseadustiku üldosa ja väärteomenetluse seadustiku sätteid.

(2) Käesoleva seaduse §-s 16<sup>1</sup> sätestatud väärteo kohtuväline menetleja on:
