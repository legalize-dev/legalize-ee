...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/12897090"
...
(2) , lähtudes jäätmete päritolust, koostisest, ohtlike ainete kemikaaliseaduse mõttes sisaldusest ning käesoleva seaduse §-s 8 nimetatud kahjulikust toimest.
...
4) teiste isikute tekitatud ja üleantud metallijäätmete kogumiseks või veoks, välja arvatud pakendiaktsiisi seaduse alusel maksustatava metallist joogipakendi kogumiseks või veoks, jäätmete edasise kaubandusvahendamise või taaskasutamise eesmärgil;
...
(1) Järelevalve käesoleva seaduse nõuete täitmise üle toimub keskkonnajärelevalve seaduses sätestatud korras.
...
(4) Järelevalvet käesoleva seaduse § 27 nõuete järgimise üle teostab lisaks Keskkonnainspektsioonile Tehnilise Järelevalve Amet.
...
(1) Käesoleva seaduse §-des 120–126 nimetatud väärtegude menetlemisel kohaldatakse karistusseadustiku ja väärteomenetluse seadustiku sätteid.
...
(1) Seadustes asendatud sõnad "andmekogude seadus" sõnadega "avaliku teabe seadus" vastavas käändes.
