...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/13263408"
...
(15) Kohtutäitur võib täitemenetluse käigus lõhkematerjali või pürotehnilist toodet võõrandada üksnes selle omandamise õigust omavale isikule. Täitemenetluse toimingud, mis käsitlevad lõhkematerjali või pürotehnilist toodet, tuleb kooskõlastada Tehnilise Järelevalve Ametiga.
...
(23) Lõhkematerjali võib turule lasta üksnes siis, kui:
...
(56) Komisjon võib käitlemisloa andmisest või selle kehtivuse pikendamisest keelduda, kui:
...
(87) Lõhkematerjalitehase käitamisluba on nõutav järgmistel juhtudel:
...
(102) Lõhkematerjalitehase taaskäivitamiseks tuleb taotleda uus käitamisluba järgmistel juhtudel:
...
(106) Lõhkematerjaliladu käesoleva seaduse tähenduses on lõhkematerjali hoidmiseks ettenähtud ehitis, ehitise osa või ehitiste kompleks.
...
(139) Käesoleva seaduse tähenduses on enamohtlik lõhketöö:
...
(6) Pürotehnilise toote tootja (edaspidi

*tootja*

) on isik, kes kavandab või toodab pürotehnilist toodet või kes on lasknud sellist toodet kavandada ja toota eesmärgiga see oma nimel või oma kaubamärgi all turule lasta.
...
(2) Euroopa Majanduspiirkonna lepinguriigist võib pürotehnilisi tooteid Eestisse turule laskmiseks või kasutamiseks tuua vaid käesoleva seaduse §-s 53

<sup>1</sup>

sätestatud tegevusluba omav pürotehnilise toote käitleja.
...
(2) Kategooriate IV ja T2 pürotehnilisi tooteid võib kasutada üksnes käesoleva seaduse §-s 53

<sup>1</sup>

sätestatud tegevusluba omav pürotehnilise toote käitleja, kellel on selleks tööks käesoleva seaduse nõuetele vastav pürotehnik.
...
(1) Avalikel üritustel või tiheasustusega asulates ilutulestiku korraldamiseks kategooriate III ja IV pürotehniliste toodetega peab olema ilutulestiku toimumiskohajärgse valla- või linnavalitsuse, tema poolt volitatud valla- või linnavalitsuse asutuse või valla- või linnavalitsuse struktuuriüksuse (edaspidi
...
(2) Pürotehnilise toote käitlemise korraldaja on nõutav ettevõtjal, kellel peab pürotehnilise toote käitlemiseks olema käesoleva seaduse § 53
...
(1) Tehnilise Järelevalve Amet avalikustab lõhkematerjalisektori ettevõtja ning pürotehnilise toote käitleja (edaspidi

*ettevõtja*

) kohta käivad andmed majandustegevuse registri (edaspidi
...
(266) Käesolevas seaduses ja selle alusel kehtestatud õigusaktides sätestatud nõuete täitmise üle teostavad riiklikku järelevalvet:
...
(267) Tehnilise Järelevalve Ameti pädevuses on:
...
(269) Päästeamet teostab järelevalvet lõhkematerjali ja pürotehnilise toote käitlemise kohtade tuleohutuse üle vastavalt päästeseadusele, arvestades käesolevast seadusest tulenevaid erisusi.

##### § 78. Tarbijakaitseameti pädevus

(270) Tarbijakaitseamet teostab järelevalvet pürotehnilise toote jaekaubanduse üle vastavalt tarbijakaitseseadusele, arvestades käesolevast seadusest tulenevaid erisusi.

##### § 79. Maksu- ja Tolliameti pädevus

(271) Maksu- ja Tolliamet teostab järelevalvet lõhkematerjali kolmandast riigist sisseveo ja kolmandasse riiki väljaveo üle vastavalt tollieeskirjadele tolliseaduse tähenduses, arvestades käesolevast seadusest tulenevaid erisusi.
...
(300) Käesoleva seaduse alusel nõutava pädevustunnistuseta tegutsemise eest tegevusalal, millel nõutakse töötajalt pädevustunnistust, – karistatakse rahatrahviga kuni 200 trahviühikut.
