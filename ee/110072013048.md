...
status: "repealed"
source: "https://www.riigiteataja.ee/akt/131102013003"
department: "Kultuuriminister"
text_type: "terviktekst"
adoption_date: "2013-07-08"
act_number: "10"
original_effective_date: "2013-07-15"
original_publication: "RT I, 2013, 48"
rt_section: "RT I"
rt_year: "2013"
rt_article: "3"
rt_reference: "131102013003"
effective_from: "2013-11-03"
...
(2) Muuseumi postiaadress on Veski 32, 51014 Tartu.
...
(1) Muuseumi põhiülesanne on eesti, soome-ugri ja teise põhjarahvaste, samuti Eestis elavate rahvusgruppide ja naaberrahvaste kultuuri kajastava materjali kogumine, säilitamine, uurimine ning vahendamine hariduslikel, teaduslikel ja elamuslikel eesmärkidel.

(2) Muuseum:

1) kogub kultuuri arengut iseloomustavat materjali nii eestlastelt, soome-ugri ja teistelt põhjarahvastelt kui ka Eestis elavatelt rahvusgruppidelt ja naaberrahvastelt;
...
1) Heimtali muuseum, mille põhiülesanne on paikkondliku omakultuuri uurimine ja arendamine, rahvusliku käsitöö kogumine, säilitamine ja uurimine, rahvusliku tekstiilikunsti alase õppe-, rakendus- ja arendustegevuse korraldamine;

2) kantselei, mille põhiülesanne on muuseumi raamatupidamise ja finantsarvestuse korraldamine, personalitöö läbiviimine, dokumendihalduse, side- ja infotehnoloogilise teenindamise korraldamine;
...
4) konserveerimisosakond, mille põhiülesanne on museaalide konserveerimine ja restaureerimine, museaalidest koopiate valmistamine; nõustamine muuseumikogu säilitamise, konserveerimise ja restaureerimise küsimustes, muuseumikogu säilitustingimuste tagamine ja kontroll, erialane teaduslik ja metoodiline töö;

5) majandusosakond, mille põhiülesanne on muuseumi varustamine ülesannete täitmiseks vajalike vahenditega, hooldus- ja remonditööde, valve ning tuletõrje korraldamine, turvasüsteemi arendamine, Raadi mõisakompleksi ja kõrvalhoonete korrashoid, hooldamine, väljaarendamine ning rakendamine;

6) näituste ja muuseumiõppe osakond, mille põhiülesanne on näituste kujundamine, ülespanek, tutvustamine, korrashoid ja külastajate üle arvestuse pidamine, näituste inventari ja abivahendite hankimine ning hooldamine, haridusprogramme koostamine ja läbiviimine, muuseumi puudutava informatsiooni levitamine ja avalike suhete korraldamine, avalike ürituste korraldamine, konverentsisaali, kohviku ja muuseumipoe töö korraldamine, kujundustööde korraldamine;

7) omakultuuride osakond, mille põhiülesanne on maakondades tegutsevate riigimuuseumide, riigi sihtasutuse muuseumide ja riigile kuuluvat muuseumikogu kasutavate muuseumide nõustamine ning koostööl põhinevate arendusprojektide koordineerimine;

8) teadusosakond, mille põhiülesanne on eestlaste ja teiste soome-ugri rahvaste, Eestis elavate rahvusgruppide ja eestlaste naaberrahvaste kultuure kajastava ainese kogumine, süstematiseerimine, uurimine ja tutvustamine, etnoloogia- ja museoloogiaalane uurimistöö, teiste soome-ugri rahvaste muuseumide ja muude etnoloogia ning museoloogiaga tegelevate asutuste ja organisatsioonide koostöö arendamine, muuseumi trükiste toimetamine, nõustamine rahvakultuuri küsimustes, fototööde ning filmi- ja videotööde korraldamine.
